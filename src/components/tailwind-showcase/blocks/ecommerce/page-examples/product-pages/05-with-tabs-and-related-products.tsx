  ...
  return (
    <div className="bg-paper">
                    ...
                    <div className="grid grid-cols-2 gap-x-4">
                      {category.featured.map((item) => (
                        <div key={item.name} className="group relative text-sm">
                          ...
                          />
                          <a href={item.href} className="mt-6 block font-medium text-charcoal">
      ...
      <header className="relative bg-paper">
        <p className="flex h-10 items-center justify-center bg-ember px-4 text-sm font-medium text-paper sm:px-6 lg:px-8">
          ...
          <div className="border-b border-paper-200">
            <div className="flex h-16 items-center">
              <button
                ...
                className="relative rounded-md bg-paper p-2 text-warm-500 lg:hidden"
              >
                <span className="absolute -inset-0.5" />
                          ...
                          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                              ...
                              <div className="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm">
                                {category.sections.map((section) => (
                                  <div key={section.name}>
                                    <p id={`${section.id}-heading`} className="font-medium text-charcoal">
                                      {section.name}
                                    </p>
                                    <ul
                                      role="list"
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a href="#" className="text-sm font-medium text-warm-700 hover:text-charcoal">
                    Sign in
                  </a>
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-warm-700 hover:text-charcoal">
                    <img
                      alt=""
                      src="/assets/logo-tqa.jpg"
                      className="block h-auto w-5 shrink-0"
      ...
      <main className="mx-auto px-4 pt-14 pb-24 sm:px-6 sm:pt-16 sm:pb-32 lg:max-w-7xl lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="lg:col-span-4 lg:row-end-1">
            <img
              ...
              className="aspect-4/3 w-full rounded-lg bg-paper-soft object-cover"
            />
          </div>
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            <div className="flex flex-col-reverse">
              <div className="mt-4">
                <h1 className="text-2xl font-bold tracking-tight text-charcoal sm:text-3xl">{product.name}</h1>
            ...
            <p className="mt-6 text-warm-500">{product.description}</p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
              ...
              <button
                type="button"
                className="flex w-full items-center justify-center rounded-md border border-transparent bg-ember-100 px-8 py-3 text-base font-medium text-indigo-700 hover:bg-indigo-100 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-hidden"
              >
                Preview
              </button>
            </div>

            <div className="mt-10 border-t border-paper-200 pt-10">
              <h3 className="text-sm font-medium text-charcoal">Highlights</h3>
              <div className="mt-4">
                <ul role="list" className="list-disc space-y-1 pl-5 text-sm/6 text-warm-500 marker:text-gray-300">
            ...
            <div className="mt-10 border-t border-paper-200 pt-10">
              <h3 className="text-sm font-medium text-charcoal">License</h3>
              <p className="mt-4 text-sm text-warm-500">
                {license.summary}{' '}
                <a href={license.href} className="font-medium text-ember hover:text-indigo-500">
                  Read full license
                </a>
              </p>
            </div>
            ...
            <div className="mt-10 border-t border-paper-200 pt-10">
              <h3 className="text-sm font-medium text-charcoal">Share</h3>
              <ul role="list" className="mt-4 flex items-center space-x-6">
                <li>
                  <a href="#" className="flex size-6 items-center justify-center text-warm-500 hover:text-warm-500">
            ...
            <TabGroup>
              <div className="border-b border-paper-200">
                <TabList className="-mb-px flex space-x-8">
                  <Tab className="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-warm-700 hover:border-gray-300 hover:text-charcoal data-selected:border-indigo-600 data-selected:text-ember">
                    Customer Reviews
                  </Tab>
                  <Tab className="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-warm-700 hover:border-gray-300 hover:text-charcoal data-selected:border-indigo-600 data-selected:text-ember">
                    FAQ
              ...
              <TabPanels as={Fragment}>
                <TabPanel className="-mb-10">
                  ...
                  {reviews.featured.map((review, reviewIdx) => (
                    <div key={review.id} className="flex space-x-4 text-sm text-warm-500">
                      <div className="flex-none py-10">
                        <img alt="" src={review.avatarSrc} className="size-10 rounded-full bg-paper-soft" />
                      </div>
                      <div className={classNames(reviewIdx === 0 ? '' : 'border-t border-paper-200', 'flex-1 py-10')}>
                        <h3 className="font-medium text-charcoal">{review.author}</h3>
                        <p>
                        ...
                        <div
                          ...
                          className="mt-4 text-sm/6 text-warm-500"
                        />
                      </div>
                    </div>
                  ))}
                ...
                <TabPanel className="text-sm text-warm-500">
                  <h3 className="sr-only">Frequently Asked Questions</h3>

                  <dl>
                    {faqs.map((faq) => (
                      <Fragment key={faq.question}>
                        <dt className="mt-10 font-medium text-charcoal">{faq.question}</dt>
                        <dd className="mt-2 text-sm/6 text-warm-500">
                          <p>{faq.answer}</p>
                        </dd>
                      </Fragment>
                    ))}
                ...
                <TabPanel className="pt-10">
                  ...
                  <div
                    ...
                    className="text-sm text-warm-500 [&_h4]:mt-5 [&_h4]:font-medium [&_h4]:text-charcoal [&_li]:pl-2 [&_li::marker]:text-gray-300 [&_p]:my-2 [&_p]:text-sm/6 [&_ul]:my-4 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5 [&_ul]:text-sm/6 [&>:first-child]:mt-0"
                  />
                </TabPanel>
              </TabPanels>
            </TabGroup>
        ...
        <div className="mx-auto mt-24 max-w-2xl sm:mt-32 lg:max-w-none">
          <div className="flex items-center justify-between space-x-4">
            <h2 className="text-lg font-medium text-charcoal">Customers also viewed</h2>
            <a href="#" className="text-sm font-medium whitespace-nowrap text-ember hover:text-indigo-500">
              View all
            ...
            {relatedProducts.map((product) => (
              <div key={product.id} className="group relative">
                <div className="relative">
                  ...
                  >
                    <div className="w-full rounded-md bg-paper/75 px-4 py-2 text-center text-sm font-medium text-charcoal backdrop-blur-sm backdrop-filter">
                      View Product
                    </div>
                  </div>
                </div>
                <div className="mt-4 flex items-center justify-between space-x-8 text-base font-medium text-charcoal">
                  <h3>
                    <a href="#">
                ...
                <p className="mt-1 text-sm text-warm-500">{product.category}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 py-20 md:grid-flow-col md:auto-rows-min md:grid-cols-12 md:gap-x-8 md:gap-y-16">
            ...
            <div className="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
              ...
              <p className="mt-1 text-sm text-warm-500">Be the first to know when we release new products.</p>
          ...
          <div className="border-t border-paper-200 py-10 text-center">
            <p className="text-sm text-warm-500">&copy; 2021 Your Company, Inc.</p>
          </div>
        </div>
      </footer>
    </div>
