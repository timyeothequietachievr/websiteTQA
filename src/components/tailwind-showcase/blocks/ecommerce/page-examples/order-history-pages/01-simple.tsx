    ...
    <div className="bg-paper">
      ...
      >
        <div className="max-w-xl">
          <h1 id="order-history-heading" className="text-3xl font-bold tracking-tight text-charcoal">
            Order history
          </h1>
        ...
        <div className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4">
          {orders.map((order) => (
            <div key={order.id} className="group relative">
              ...
              />
              <h3 className="mt-4 text-sm text-warm-500">
                <a href={order.href}>
              ...
              <p className="mt-1 text-lg font-medium">
                {order.status === 'delivered' ? (
                  ...
                  <span className="text-ember">Out for delivery</span>
                ) : order.status === 'cancelled' ? (
                  <span className="text-warm-500">Cancelled</span>
                ) : null}
              </p>
            </div>
          ))}
