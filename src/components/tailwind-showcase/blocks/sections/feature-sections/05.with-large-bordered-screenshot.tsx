  ...
  return (
    <div className="overflow-hidden bg-paper py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <p className="max-w-2xl text-5xl font-display font-semibold tracking-tight text-pretty text-charcoal sm:text-6xl sm:text-balance">
        ...
        <div className="relative mt-16 aspect-2432/1442 h-144 sm:h-auto sm:w-[calc(var(--container-7xl)-calc(var(--spacing)*16))]">
          ...
          <img
            alt=""
            src="/assets/logo-tqa.jpg"
            className="h-full rounded-xl shadow-2xl ring-1 ring-black/10 not-dark:hidden"
          />
        </div>
      </div>
    </div>
