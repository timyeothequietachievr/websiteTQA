        ...
        <div className="bg-paper">
          <div className="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 sm:pt-24 sm:pb-32 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            ...
            <div className="lg:max-w-lg lg:self-end">
                  ...
                  {product.breadcrumbs.map((breadcrumb, breadcrumbIdx) => (
                    <li key={breadcrumb.id}>
                      <div className="flex items-center text-sm">
                        <a href={breadcrumb.href} className="font-medium text-warm-500 hover:text-charcoal">
                          {breadcrumb.name}
                        </a>
              ...
              <div className="mt-4">
                <h1 className="text-3xl font-bold tracking-tight text-charcoal sm:text-4xl">{product.name}</h1>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4 border-l border-gray-300 pl-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="ml-2 text-sm text-warm-500">{reviews.totalCount} reviews</p>
                    </div>
                  </div>
                </div>

                <div className="mt-4 space-y-6">
                  <p className="text-base text-warm-500">{product.description}</p>
                </div>

                <div className="mt-6 flex items-center">
                  <CheckIcon aria-hidden="true" className="size-5 shrink-0 text-green-500" />
                  <p className="ml-2 text-sm text-warm-500">In stock and ready to ship</p>
                </div>
              </section>
            </div>
            ...
            <div className="mt-10 lg:col-start-1 lg:row-start-2 lg:max-w-lg lg:self-start">
              <section aria-labelledby="options-heading">
                ...
                <form>
                  ...
                  <div className="mt-4">
                    <a href="#" className="group inline-flex text-sm text-warm-500 hover:text-warm-700">
                  ...
                  <div className="mt-6 text-center">
                    <a href="#" className="group inline-flex text-base font-medium">
                      ...
                      />
                      <span className="text-warm-500 hover:text-warm-700">Lifetime Guarantee</span>
                    </a>
                  </div>
                </form>
              </section>
            ...
            <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8">
              {policies.map((policy) => (
                <div key={policy.name}>
                  ...
                  <h3 className="mt-6 text-base font-medium text-charcoal">{policy.name}</h3>
                  <p className="mt-3 text-base text-warm-500">{policy.description}</p>
                </div>
              ))}
            </div>
          </section>
        ...
        <section aria-labelledby="reviews-heading" className="bg-paper">
          <div className="mx-auto max-w-2xl px-4 py-24 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-x-8 lg:px-8 lg:py-32">
            <div className="lg:col-span-4">
              <h2 id="reviews-heading" className="text-2xl font-bold tracking-tight text-charcoal">
                Customer Reviews
              </h2>
              ...
              <div className="mt-3 flex items-center">
                ...
                <p className="ml-2 text-sm text-charcoal">Based on {reviews.totalCount} reviews</p>
              </div>
                  ...
                  {reviews.counts.map((count) => (
                    <div key={count.rating} className="flex items-center text-sm">
                      <dt className="flex flex-1 items-center">
                        <p className="w-3 font-medium text-charcoal">
                          {count.rating}
                        ...
                        <div aria-hidden="true" className="ml-1 flex flex-1 items-center">
                          ...
                          <div className="relative ml-3 flex-1">
                            <div className="h-3 rounded-full border border-paper-200 bg-paper-soft" />
                            {count.count > 0 ? (
                              <div
                      ...
                      <dd className="ml-3 w-10 text-right text-sm text-charcoal tabular-nums">
              ...
              <div className="mt-10">
                <h3 className="text-lg font-medium text-charcoal">Share your thoughts</h3>
                ...
                <a
                  href="#"
                  className="mt-6 inline-flex w-full items-center justify-center rounded-md border border-gray-300 bg-paper px-8 py-2 text-sm font-medium text-charcoal hover:bg-paper-soft sm:w-auto lg:w-full"
                >
                  Write a review
                </a>
              </div>
                  ...
                  {reviews.featured.map((review) => (
                    <div key={review.id} className="py-12">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <h4 className="text-sm font-bold text-charcoal">{review.author}</h4>
                      ...
                      <div
                        ...
                        className="mt-4 space-y-6 text-base text-warm-500 italic"
                      />
                    </div>
                  ))}
                </div>
