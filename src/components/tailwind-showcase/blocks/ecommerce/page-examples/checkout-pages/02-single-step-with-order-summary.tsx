    ...
    <div className="bg-paper-soft">
                      ...
                      {category.featured.map((item) => (
                        <div key={item.name} className="group relative">
                          <img
                            alt={item.imageAlt}
                            src={item.imageSrc}
                            className="aspect-square w-full rounded-md bg-paper-soft object-cover group-hover:opacity-75"
                          />
                          <a href={item.href} className="mt-6 block text-sm font-medium text-charcoal">
                            <span aria-hidden="true" className="absolute inset-0 z-10" />
                            {item.name}
                          </a>
                          <p aria-hidden="true" className="mt-1 text-sm text-warm-500">
                            Shop now
                          </p>
                        </div>
                      ))}
      ...
      <header className="relative">
        <nav aria-label="Top">
          ...
          <div className="bg-paper shadow-xs">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex h-full justify-center space-x-8">
                      {navigation.categories.map((category) => (
                        <Popover key={category.name} className="flex">
                          ...
                          <PopoverPanel
                            transition
                            className="group/popover-panel absolute inset-x-0 top-full z-20 w-full bg-paper text-sm text-warm-500 transition data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
                          >
                                  ...
                                  {category.featured.map((item) => (
                                    <div key={item.name} className="group relative">
                                      <img
                                        ...
                                        className="aspect-square w-full rounded-md bg-paper-soft object-cover group-hover:opacity-75"
                                      />
                                      <a href={item.href} className="mt-4 block font-medium text-charcoal">
                                        <span aria-hidden="true" className="absolute inset-0 z-10" />
                                        {item.name}
                                      </a>
                ...
                <div className="flex flex-1 items-center justify-end">
                  <a href="#" className="hidden text-sm font-medium text-warm-700 hover:text-charcoal lg:block">
                    Search
                  </a>

                  <div className="flex items-center lg:ml-8">
                    {/* Help */}
                    <a href="#" className="p-2 text-warm-500 hover:text-warm-500 lg:hidden">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-16 pb-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <form className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
            <div>
              <div>
                <h2 className="text-lg font-medium text-charcoal">Contact information</h2>
              ...
              <div className="mt-10 border-t border-paper-200 pt-10">
                <h2 className="text-lg font-medium text-charcoal">Shipping information</h2>

                <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                  <div>
                    <label htmlFor="first-name" className="block text-sm/6 font-medium text-warm-700">
                      First name
                    </label>
                    <div className="mt-2">
                      <input
                  ...
                  <div>
                    <label htmlFor="last-name" className="block text-sm/6 font-medium text-warm-700">
                      Last name
                    </label>
                    <div className="mt-2">
                      <input
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="company" className="block text-sm/6 font-medium text-warm-700">
                      Company
                    </label>
                    <div className="mt-2">
                      <input
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="apartment" className="block text-sm/6 font-medium text-warm-700">
                      Apartment, suite, etc.
                    </label>
                    <div className="mt-2">
                      <input
                  ...
                  <div>
                    <label htmlFor="country" className="block text-sm/6 font-medium text-warm-700">
                      Country
                    </label>
                    <div className="mt-2 grid grid-cols-1">
                      <select
                        ...
                        className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-paper py-2 pr-8 pl-3 text-base text-charcoal outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                      >
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="phone" className="block text-sm/6 font-medium text-warm-700">
                      Phone
                    </label>
                    <div className="mt-2">
                      <input
              ...
              <div className="mt-10 border-t border-paper-200 pt-10">
                <h2 className="text-lg font-medium text-charcoal">Delivery method</h2>
                    ...
                    {deliveryMethods.map((deliveryMethod) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <span className="block text-sm font-medium text-charcoal">{deliveryMethod.title}</span>
                          <span className="mt-1 block text-sm text-warm-500">{deliveryMethod.turnaround}</span>
                          <span className="mt-6 block text-sm font-medium text-charcoal">{deliveryMethod.price}</span>
                        </div>
                        <CheckCircleIcon
                          aria-hidden="true"
              ...
              {/* Payment */}
              <div className="mt-10 border-t border-paper-200 pt-10">
                <h2 className="text-lg font-medium text-charcoal">Payment</h2>
                  ...
                  <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                    {paymentMethods.map((paymentMethod, paymentMethodIdx) => (
                      <div key={paymentMethod.id} className="flex items-center">
                        ...
                        />
                        <label htmlFor={paymentMethod.id} className="ml-3 block text-sm/6 font-medium text-warm-700">
                          {paymentMethod.title}
                        </label>
                      </div>
                    ))}
                ...
                <div className="mt-6 grid grid-cols-4 gap-x-4 gap-y-6">
                  ...
                  <div className="col-span-4">
                    <label htmlFor="name-on-card" className="block text-sm/6 font-medium text-warm-700">
                      Name on card
                    </label>
                    <div className="mt-2">
                      <input
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-4 rounded-lg border border-paper-200 bg-paper shadow-xs">
                      ...
                      <div className="ml-6 flex flex-1 flex-col">
                        <div className="flex">
                          ...
                          <div className="ml-4 flow-root shrink-0">
                            <button
                              type="button"
                              className="-m-2.5 flex items-center justify-center bg-paper p-2.5 text-warm-500 hover:text-warm-500"
                            >
                ...
                <dl className="space-y-6 border-t border-paper-200 px-4 py-6 sm:px-6">
                  <div className="flex items-center justify-between">
                    <dt className="text-sm">Subtotal</dt>
                    <dd className="text-sm font-medium text-charcoal">$64.00</dd>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <dd className="text-sm font-medium text-charcoal">$5.52</dd>
                  </div>
                  <div className="flex items-center justify-between border-t border-paper-200 pt-6">
                    <dt className="text-base font-medium">Total</dt>
                    <dd className="text-base font-medium text-charcoal">$75.52</dd>
                  </div>
                </dl>

                <div className="border-t border-paper-200 px-4 py-6 sm:px-6">
                  <button
                    type="submit"
