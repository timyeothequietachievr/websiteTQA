      ...
      <main className="isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="mt-8 text-lg font-medium text-pretty text-warm-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                  ...
                  <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-0 xl:pt-80">
                    <div className="relative">
                      <img
                        ...
                        className="aspect-2/3 w-full rounded-xl bg-ink/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-charcoal/10 ring-inset" />
                    </div>
                  </div>
          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl/8 text-warm-500">
                ...
                <p className="mt-10 max-w-xl text-base/7 text-warm-700">
                ...
                <dl className="w-64 space-y-8 xl:w-80">
                  {stats.map((stat) => (
                    <div key={stat.label} className="flex flex-col-reverse gap-y-4">
                      ...
                      <dd className="text-5xl font-display font-semibold tracking-tight text-charcoal">
                        {stat.value}
                      </dd>
                    </div>
                  ))}
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          ...
          <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base/7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {values.map((value) => (
              <div key={value.name}>
                <dt className="font-semibold text-charcoal">{value.name}</dt>
                <dd className="mt-1 text-warm-500">{value.description}</dd>
              </div>
            ))}
          </dl>
        </div>
          ...
          >
            {team.map((person) => (
              <li key={person.name}>
                ...
                />
                <h3 className="mt-6 text-base/7 font-display font-semibold tracking-tight text-charcoal">
                  {person.name}
                </h3>
                <p className="text-sm/6 text-warm-500">{person.role}</p>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {blogPosts.map((post) => (
              <article
                key={post.id}
                className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-ink px-8 pt-80 pb-8 sm:pt-48 lg:pt-80"
              >
                <img alt="" src={post.imageUrl} className="absolute inset-0 -z-10 size-full object-cover" />
                <div className="absolute inset-0 -z-10 bg-linear-to-t from-gray-900 via-gray-900/40" />
                <div className="absolute inset-0 -z-10 rounded-2xl inset-ring inset-ring-charcoal/10" />
                  ...
                  <div className="-ml-4 flex items-center gap-x-4">
                    ...
                    <div className="flex gap-x-2.5">
                      <img
                        ...
                        className="size-6 flex-none rounded-full bg-paper/10"
                      />
                      {post.author.name}
                    </div>
                  </div>
                </div>
                <h3 className="mt-3 text-lg/6 font-semibold text-paper">
                  <a href={post.href}>
