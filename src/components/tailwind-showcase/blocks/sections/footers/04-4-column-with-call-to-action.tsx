    ...
    <footer className="bg-paper">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-2xl text-center">
          <hgroup>
            <h2 className="text-base/7 font-semibold text-ember">Get started</h2>
        ...
        <div className="mt-24 border-t border-charcoal/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8">
          <img
            alt="Company name"
        ...
        <div className="mt-12 border-t border-charcoal/10 pt-8 md:flex md:items-center md:justify-between">
