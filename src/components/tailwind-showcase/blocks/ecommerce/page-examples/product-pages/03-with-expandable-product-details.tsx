...
const product = {
  ...
  colors: [
    ...
    { id: 'washed-gray', name: 'Washed Gray', classes: 'bg-paper-soft0 checked:outline-gray-500' },
  ],
  description: `
        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
              ...
              <div className="mx-auto mt-6 hidden w-full max-w-2xl sm:block lg:max-w-none">
                <TabList className="grid grid-cols-4 gap-6">
                  {product.images.map((image) => (
                    <Tab
                      key={image.id}
                      className="group relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-paper text-sm font-medium text-charcoal uppercase hover:bg-paper-soft focus:ring-3 focus:ring-indigo-500/50 focus:ring-offset-4 focus:outline-hidden"
                    >
            ...
            <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
              <h1 className="text-3xl font-bold tracking-tight text-charcoal">{product.name}</h1>
              ...
              <div className="mt-6">
                ...
                <div
                  ...
                  className="space-y-6 text-base text-warm-700"
                />
              </div>
              ...
              <form className="mt-6">
                {/* Colors */}
                <div>
                  <h3 className="text-sm text-warm-500">Color</h3>
                ...
                <div className="mt-10 flex">
                  <button
                    type="submit"
                    className="flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent bg-ember px-8 py-3 text-base font-medium text-paper hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-hidden sm:w-full"
                  >
                    Add to bag
                  </button>
                  ...
                  <button
                    type="button"
                    className="ml-4 flex items-center justify-center rounded-md px-3 py-3 text-warm-500 hover:bg-paper-soft hover:text-warm-500"
                  >
              ...
              <section aria-labelledby="details-heading" className="mt-12">
                ...
                <div className="divide-y divide-gray-200 border-t border-paper-200">
                  {product.details.map((detail) => (
                    <Disclosure key={detail.name} as="div">
                      <h3>
                        <DisclosureButton className="group relative flex w-full items-center justify-between py-6 text-left">
                          <span className="text-sm font-medium text-charcoal group-data-open:text-ember">
                            {detail.name}
                          </span>
                          <span className="ml-6 flex items-center">
                            <PlusIcon
                              aria-hidden="true"
                              className="block size-6 text-warm-500 group-hover:text-warm-500 group-data-open:hidden"
                            />
                            <MinusIcon
                              aria-hidden="true"
                              className="hidden size-6 text-ember group-hover:text-indigo-500 group-data-open:block"
                            />
                          </span>
                        </DisclosureButton>
                      </h3>
                      <DisclosurePanel className="pb-6">
                        <ul
                          role="list"
                          className="list-disc space-y-1 pl-5 text-sm/6 text-warm-700 marker:text-gray-300"
                        >
          ...
          <section aria-labelledby="related-heading" className="mt-10 border-t border-paper-200 px-4 py-16 sm:px-0">
            <h2 id="related-heading" className="text-xl font-bold text-charcoal">
