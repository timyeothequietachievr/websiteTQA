  ...
  return (
    <div className="bg-paper shadow-sm sm:rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-base font-semibold text-charcoal">Payment method</h3>
        <div className="mt-5">
          <div className="rounded-md bg-paper-soft px-6 py-5 sm:flex sm:items-start sm:justify-between">
            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 sm:mt-0 sm:ml-4">
                <div className="text-sm font-medium text-charcoal">Ending with 4242</div>
                <div className="mt-1 text-sm text-warm-500 sm:flex sm:items-center">
