...
export default function TailwindBlock() {
  return (
    <div className="fixed inset-x-0 bottom-0 flex flex-col justify-between gap-x-8 gap-y-4 border-t border-charcoal/10 bg-paper p-6 shadow-lg md:flex-row md:items-center lg:px-8">
      <p className="max-w-4xl text-sm/6 text-charcoal">
