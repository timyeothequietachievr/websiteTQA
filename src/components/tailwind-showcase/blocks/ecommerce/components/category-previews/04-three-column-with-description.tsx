  ...
  return (
    <div className="bg-paper">
      <div className="mx-auto max-w-xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-charcoal">Shop by Collection</h2>
        ...
        <div className="mt-10 space-y-12 lg:grid lg:grid-cols-3 lg:space-y-0 lg:gap-x-8">
          {categories.map((category) => (
            <a key={category.name} href={category.href} className="group block">
              ...
              />
              <h3 className="mt-4 text-base font-semibold text-charcoal">{category.name}</h3>
