...
const product = {
  ...
  colors: [
    { id: 'white', name: 'White', classes: 'bg-paper checked:outline-gray-400' },
    { id: 'gray', name: 'Gray', classes: 'bg-gray-200 checked:outline-gray-400' },
    { id: 'black', name: 'Black', classes: 'bg-ink checked:outline-gray-900' },
  ],
  sizes: [
    ...
    <div className="bg-paper">
      ...
      <main className="pt-10 sm:pt-16">
        <nav aria-label="Breadcrumb">
          <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            {product.breadcrumbs.map((breadcrumb) => (
              <li key={breadcrumb.id}>
                <div className="flex items-center">
                  <a href={breadcrumb.href} className="mr-2 text-sm font-medium text-charcoal">
                    {breadcrumb.name}
                  </a>
                  <svg
                    fill="currentColor"
            ...
            <li className="text-sm">
              <a href={product.href} aria-current="page" className="font-medium text-warm-500 hover:text-warm-500">
                {product.name}
              </a>
            </li>
          </ol>
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pt-16">
          <div className="lg:col-span-2 lg:border-r lg:border-paper-200 lg:pr-8">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-3xl tracking-tight text-charcoal">{product.price}</p>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center">
                  ...
                  {[0, 1, 2, 3, 4].map((rating) => (
                    <StarIcon
                      ...
                      className={classNames(
                        reviews.average > rating ? 'text-charcoal' : 'text-gray-200',
                        'size-5 shrink-0',
                      )}
                    />
                  ))}
                ...
                <a href={reviews.href} className="ml-3 text-sm font-medium text-ember hover:text-indigo-500">
            ...
            <form className="mt-10">
              {/* Colors */}
              <div>
                <h3 className="text-sm font-medium text-charcoal">Color</h3>
              ...
              <div className="mt-10">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium text-charcoal">Size</h3>
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {product.sizes.map((size) => (
                      <label
                        ...
                        className="group relative flex items-center justify-center rounded-md border border-gray-300 bg-paper p-3 has-checked:border-indigo-600 has-checked:bg-ember has-focus-visible:outline-2 has-focus-visible:outline-offset-2 has-focus-visible:outline-ember has-disabled:border-gray-400 has-disabled:bg-gray-200 has-disabled:opacity-25"
                      >
                        <input
                        ...
                        />
                        <span className="text-sm font-medium text-charcoal uppercase group-has-checked:text-paper">
                          {size.name}
                        </span>
                      </label>
                    ))}
              ...
              <button
                type="submit"
                className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-ember px-8 py-3 text-base font-medium text-paper hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden"
              >
                Add to bag
              </button>
            </form>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-paper-200 lg:pt-6 lg:pr-8 lg:pb-16">
              ...
              <div className="mt-4">
                <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                  {product.highlights.map((highlight) => (
                    <li key={highlight} className="text-warm-500">
                      <span className="text-warm-500">{highlight}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <section aria-labelledby="shipping-heading" className="mt-10">
              <h2 id="shipping-heading" className="text-sm font-medium text-charcoal">
                Details
              </h2>

              <div className="mt-4 space-y-6">
                <p className="text-sm text-warm-500">{product.details}</p>
              </div>
            </section>
          </div>
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-paper-200 lg:pr-8">
            {/* Reviews */}
            <section aria-labelledby="reviews-heading" className="border-t border-paper-200 pt-10 lg:pt-16">
                ...
                {reviews.featured.map((review) => (
                  <div key={review.id} className="flex flex-col sm:flex-row">
                    <div className="order-2 mt-6 sm:mt-0 sm:ml-16">
                      <h3 className="text-sm font-medium text-charcoal">{review.title}</h3>
                      <p className="sr-only">{review.rating} out of 5 stars</p>

                      <div
                        dangerouslySetInnerHTML={{ __html: review.content }}
                        className="mt-3 space-y-6 text-sm text-warm-500"
                      />
                    </div>
                        ...
                        <div className="mt-2 flex items-center">
                          {[0, 1, 2, 3, 4].map((rating) => (
                            <StarIcon
                              ...
                              aria-hidden="true"
                              className={classNames(
                                review.rating > rating ? 'text-charcoal' : 'text-gray-200',
                                'size-5 shrink-0',
                              )}
                            />
                          ))}
        ...
        <section aria-labelledby="related-products-heading" className="bg-paper">
          <div className="mx-auto max-w-2xl px-4 py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            <h2 id="related-products-heading" className="text-xl font-bold tracking-tight text-charcoal">
              ...
              {products.map((product) => (
                <div key={product.id} className="group relative">
                  ...
                  <div className="mt-4 flex justify-between">
                    <div>
                      <h3 className="text-sm text-warm-700">
                        <a href={product.href}>
