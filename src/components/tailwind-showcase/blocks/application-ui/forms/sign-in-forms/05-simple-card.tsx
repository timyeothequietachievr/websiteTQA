      ...
      */}
      <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          />
          <h2 className="mt-6 text-center text-2xl/9 font-bold tracking-tight text-charcoal">
            Sign in to your account
          </h2>
        </div>

        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-paper px-6 py-12 shadow-sm sm:rounded-lg sm:px-12">
            ...
            <div>
              <div className="mt-10 flex items-center gap-x-6">
                <div className="w-full flex-1 border-t border-paper-200" />
                <p className="text-sm/6 font-medium text-nowrap text-charcoal">Or continue with</p>
                <div className="w-full flex-1 border-t border-paper-200" />
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <a
                  href="#"
                  className="flex w-full items-center justify-center gap-3 rounded-md bg-paper px-3 py-2 text-sm font-semibold text-charcoal shadow-xs inset-ring inset-ring-gray-300 hover:bg-paper-soft focus-visible:inset-ring-transparent"
                >
