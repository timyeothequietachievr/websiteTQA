...
export default function TailwindBlock() {
  return (
    <section className="bg-paper px-6 py-24 sm:py-32 lg:px-8">
      <figure className="mx-auto max-w-2xl">
        <p className="sr-only">5 out of 5 stars</p>
        <div className="flex gap-x-1 text-ember">
        ...
        <blockquote className="mt-10 text-xl/8 font-display font-semibold tracking-tight text-charcoal sm:text-2xl/9">
          <p>
        ...
        <figcaption className="mt-10 flex items-center gap-x-6">
          ...
          <div className="text-sm/6">
            ...
            <div className="mt-0.5 text-warm-500">CEO of Workcation</div>
          </div>
        </figcaption>
      </figure>
    </section>
