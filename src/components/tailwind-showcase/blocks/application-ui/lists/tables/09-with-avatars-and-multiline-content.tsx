                  ...
                  <tr key={person.email}>
                    <td className="py-5 pr-3 pl-4 text-sm whitespace-nowrap sm:pl-0">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="font-medium text-charcoal">{person.name}</div>
                          <div className="mt-1 text-warm-500">{person.email}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-3 py-5 text-sm whitespace-nowrap text-warm-500">
                      <div className="text-charcoal">{person.title}</div>
                      <div className="mt-1 text-warm-500">{person.department}</div>
                    </td>
                    <td className="px-3 py-5 text-sm whitespace-nowrap text-warm-500">
