...
export default function TailwindBlock() {
  ...
  return (
    <div className="bg-paper">
      ...
      <div className="relative bg-ink">
        ...
        <header className="relative z-10">
          <nav aria-label="Top">
            ...
            <div className="bg-paper/10 backdrop-blur-md backdrop-filter">
                ...
                <div>
                  <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex h-full justify-center space-x-8">
                          {navigation.categories.map((category) => (
                            <Popover key={category.name} className="flex">
                              <div className="relative flex">
                                <PopoverButton className="group relative flex items-center justify-center text-sm font-medium text-paper transition-colors duration-200 ease-out">
                                  {category.name}
                                  <span
                                    aria-hidden="true"
                                    className="absolute inset-x-0 -bottom-px z-30 h-0.5 transition duration-200 ease-out group-data-open:bg-paper"
                                  />
                                </PopoverButton>
                              </div>
                              <PopoverPanel
                          ...
                          {navigation.pages.map((page) => (
                            <a
                              key={page.name}
                              href={page.href}
                              className="flex items-center text-sm font-medium text-paper"
                            >
                              {page.name}
                            </a>
                          ))}
                    ...
                    <div className="flex flex-1 items-center lg:hidden">
                      <button type="button" onClick={() => setMobileMenuOpen(true)} className="-ml-2 p-2 text-paper">
                        <span className="sr-only">Open menu</span>
                        <Bars3Icon aria-hidden="true" className="size-6" />
                      </button>

                      {/* Search */}
                      <a href="#" className="ml-2 p-2 text-paper">
                    ...
                    <div className="flex flex-1 items-center justify-end">
                      <a href="#" className="hidden text-sm font-medium text-paper lg:block">
                        Search
                      </a>

                      <div className="flex items-center lg:ml-8">
                        {/* Help */}
                        <a href="#" className="p-2 text-paper lg:hidden">
                        ...
                        <div className="ml-4 flow-root lg:ml-8">
                          <a href="#" className="group -m-2 flex items-center p-2">
                            <ShoppingBagIcon aria-hidden="true" className="size-6 shrink-0 text-paper" />
                            <span className="ml-2 text-sm font-medium text-paper">0</span>
      ...
      <main>
        ...
        <section aria-labelledby="category-heading" className="pt-24 sm:pt-32 xl:mx-auto xl:max-w-7xl xl:px-8">
          <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
            <h2 id="category-heading" className="text-2xl font-bold tracking-tight text-charcoal">
              Shop by Category
            </h2>
                ...
                <div className="absolute flex space-x-8 px-4 sm:px-6 lg:px-8 xl:relative xl:grid xl:grid-cols-5 xl:gap-x-8 xl:space-x-0 xl:px-0">
                  {categories.map((category) => (
                    ...
                    >
                      ...
                      />
                      <span className="relative mt-auto text-center text-xl font-bold text-paper">{category.name}</span>
                    </a>
                  ))}
                </div>
              </div>
          ...
          <div className="relative overflow-hidden rounded-lg">
            ...
            <div className="relative bg-ink/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
              <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                <h2 id="social-impact-heading" className="text-3xl font-bold tracking-tight text-paper sm:text-4xl">
        ...
        >
          <h2 id="collection-heading" className="text-2xl font-bold tracking-tight text-charcoal">
            Shop by Collection
          </h2>
          ...
          <div className="mt-10 space-y-12 lg:grid lg:grid-cols-3 lg:space-y-0 lg:gap-x-8">
            {collections.map((collection) => (
              <a key={collection.name} href={collection.href} className="group block">
                ...
                />
                <h3 className="mt-4 text-base font-semibold text-charcoal">{collection.name}</h3>
                <p className="mt-2 text-sm text-warm-500">{collection.description}</p>
              </a>
            ))}
          </div>
        </section>
        ...
        <section aria-labelledby="comfort-heading" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="relative overflow-hidden rounded-lg">
            ...
            <div className="relative bg-ink/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
              <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                <h2 id="comfort-heading" className="text-3xl font-bold tracking-tight text-paper sm:text-4xl">
                  Simple productivity
                </h2>
                <p className="mt-3 text-xl text-paper">
      ...
      <footer aria-labelledby="footer-heading" className="bg-ink">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              <div className="space-y-12 md:grid md:grid-cols-2 md:gap-8 md:space-y-0">
                <div>
                  <h3 className="text-sm font-medium text-paper">Shop</h3>
                  <ul role="list" className="mt-6 space-y-6">
                    {footerNavigation.shop.map((item) => (
                      <li key={item.name} className="text-sm">
                        <a href={item.href} className="text-gray-300 hover:text-paper">
                          {item.name}
                        </a>
                      </li>
                    ))}
                ...
                <div>
                  <h3 className="text-sm font-medium text-paper">Company</h3>
                  <ul role="list" className="mt-6 space-y-6">
              ...
              <div className="space-y-12 md:grid md:grid-cols-2 md:gap-8 md:space-y-0">
                <div>
                  <h3 className="text-sm font-medium text-paper">Account</h3>
                  <ul role="list" className="mt-6 space-y-6">
                ...
                <div>
                  <h3 className="text-sm font-medium text-paper">Connect</h3>
                  <ul role="list" className="mt-6 space-y-6">
            ...
            <div className="mt-12 md:mt-16 xl:mt-0">
              <h3 className="text-sm font-medium text-paper">Sign up for our newsletter</h3>
              ...
              <form className="mt-2 flex sm:max-w-md">
                <input
                  ...
                  className="block w-full rounded-md bg-paper px-4 py-2 text-base text-charcoal outline-1 -outline-offset-1 outline-gray-300 placeholder:text-warm-500 focus:outline-2 focus:outline-offset-2 focus:outline-white"
                />
                <div className="ml-4 shrink-0">
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-ember px-4 py-2 text-base font-medium text-paper shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900 focus:outline-hidden"
                  >
                    Sign up
                  </button>
                </div>
          ...
          <div className="border-t border-gray-800 py-10">
            <p className="text-sm text-warm-500">Copyright &copy; 2021 Your Company, Inc.</p>
          </div>
        </div>
      </footer>
    </div>
