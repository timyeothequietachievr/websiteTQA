    ...
    <div className="bg-paper">
                            ...
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                              <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                ...
                                <div className="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm">
                                  {category.sections.map((section) => (
                                    <div key={section.name}>
                                      <p id={`${section.name}-heading`} className="font-medium text-charcoal">
                                        {section.name}
                                      </p>
                                      <ul
                                        role="list"
      ...
      <div>
        ...
        <Dialog open={mobileFiltersOpen} onClose={setMobileFiltersOpen} className="relative z-40 lg:hidden">
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              ...
              {/* Filters */}
              <form className="mt-4 border-t border-paper-200">
                <h3 className="sr-only">Categories</h3>
                <ul role="list" className="px-2 py-3 font-medium text-charcoal">
                ...
                {filters.map((section) => (
                  <Disclosure key={section.id} as="div" className="border-t border-paper-200 px-4 py-6">
                    <h3 className="-mx-2 -my-3 flow-root">
                      <DisclosureButton className="group flex w-full items-center justify-between bg-paper px-2 py-3 text-warm-500 hover:text-warm-500">
                        ...
                        {section.options.map((option, optionIdx) => (
                          <div key={option.value} className="flex gap-3">
                            ...
                            <label
                              ...
                              className="min-w-0 flex-1 text-warm-500"
                            >
                              {option.label}
                            </label>
                          </div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-paper-200 pt-24 pb-6">
            <h1 className="text-4xl font-bold tracking-tight text-charcoal">New Arrivals</h1>
            ...
            <div className="flex items-center">
              ...
              <button type="button" className="-m-2 ml-5 p-2 text-warm-500 hover:text-warm-500 sm:ml-7">
              ...
              <button
                ...
                className="-m-2 ml-4 p-2 text-warm-500 hover:text-warm-500 sm:ml-6 lg:hidden"
              >
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                <h3 className="sr-only">Categories</h3>
                <ul role="list" className="space-y-4 border-b border-paper-200 pb-6 text-sm font-medium text-charcoal">
                  {subCategories.map((category) => (
                    <li key={category.name}>
                ...
                {filters.map((section) => (
                  <Disclosure key={section.id} as="div" className="border-b border-paper-200 py-6">
                    <h3 className="-my-3 flow-root">
                      <DisclosureButton className="group flex w-full items-center justify-between bg-paper py-3 text-sm text-warm-500 hover:text-warm-500">
                        <span className="font-medium text-charcoal">{section.name}</span>
                        <span className="ml-6 flex items-center">
                          <PlusIcon aria-hidden="true" className="size-5 group-data-open:hidden" />
                          <MinusIcon aria-hidden="true" className="size-5 group-not-data-open:hidden" />
                      ...
                      <div className="space-y-4">
                        {section.options.map((option, optionIdx) => (
                          <div key={option.value} className="flex gap-3">
                            ...
                            <label htmlFor={`filter-${section.id}-${optionIdx}`} className="text-sm text-warm-500">
                              {option.label}
                            </label>
                          </div>
                        ))}
