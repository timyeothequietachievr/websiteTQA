              ...
              <article key={post.id} className="relative isolate flex flex-col gap-8 lg:flex-row">
                <div className="relative aspect-video sm:aspect-2/1 lg:aspect-square lg:w-64 lg:shrink-0">
                  <img
                    alt=""
                    src={post.imageUrl}
                    className="absolute inset-0 size-full rounded-2xl bg-paper-soft object-cover"
                  />
                  <div className="absolute inset-0 rounded-2xl inset-ring inset-ring-charcoal/10" />
                </div>
                <div>
                  ...
                  <div className="group relative max-w-xl">
                    ...
                    <p className="mt-5 text-sm/6 text-warm-500">{post.description}</p>
                  </div>
                  <div className="mt-6 flex border-t border-charcoal/5 pt-6">
