      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden bg-paper-soft ring-1 ring-charcoal/10 lg:w-1/2">
              <svg
                aria-hidden="true"
            ...
            <dl className="mt-10 space-y-4 text-base/7 text-warm-500">
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  <span className="sr-only">Address</span>
                  <BuildingOffice2Icon aria-hidden="true" className="h-7 w-6 text-warm-500" />
                </dt>
                <dd>
                  545 Mavis Island
                  <br />
              ...
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  ...
                  <PhoneIcon aria-hidden="true" className="h-7 w-6 text-warm-500" />
                </dt>
                <dd>
                  <a href="tel:+1 (555) 234-5678" className="hover:text-charcoal">
                    +1 (555) 234-5678
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  ...
                  <EnvelopeIcon aria-hidden="true" className="h-7 w-6 text-warm-500" />
                </dt>
                <dd>
                  <a href="mailto:hello@example.com" className="hover:text-charcoal">
                    hello@example.com
                  </a>
                </dd>
              </div>
