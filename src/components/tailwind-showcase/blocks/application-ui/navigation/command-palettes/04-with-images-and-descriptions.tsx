              ...
              <ComboboxOptions static className="max-h-96 transform-gpu scroll-py-3 overflow-y-auto p-3">
                {filteredItems.map((item) => (
                  <ComboboxOption
                    key={item.id}
                    value={item}
                    className="group flex cursor-default rounded-xl p-3 select-none data-focus:bg-paper-soft data-focus:outline-hidden"
                  >
                    <div
                    ...
                    >
                      <item.icon className="size-6 text-paper" aria-hidden="true" />
                    </div>
                    <div className="ml-4 flex-auto">
                      <p className="text-sm font-medium text-warm-700 group-data-focus:text-charcoal">
                        {item.name}
                      </p>
                      <p className="text-sm text-warm-500 group-data-focus:text-warm-700">
                        {item.description}
                      </p>
                    </div>
                  </ComboboxOption>
            ...
            {query !== '' && filteredItems.length === 0 && (
              <div className="px-6 py-14 text-center text-sm sm:px-14">
                <ExclamationCircleIcon
                  ...
                  className="mx-auto size-6 text-warm-500"
                />
