...
export default function TailwindBlock() {
  return (
    <>
      <span className="inline-flex items-center rounded-md bg-paper-soft px-2 py-1 text-xs font-medium text-warm-500 inset-ring inset-ring-gray-500/10">
        Badge
      </span>
      ...
      <span className="inline-flex items-center rounded-md bg-ember-100 px-2 py-1 text-xs font-medium text-indigo-700 inset-ring inset-ring-indigo-700/10">
        Badge
      </span>
