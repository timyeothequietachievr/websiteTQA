          ...
          <div className="space-y-20">
            {orders.map((order) => (
              <div key={order.number}>
                ...
                <div className="rounded-lg bg-paper-soft px-4 py-6 sm:flex sm:items-center sm:justify-between sm:space-x-6 sm:px-6 lg:space-x-8">
                  <dl className="flex-auto divide-y divide-gray-200 text-sm text-warm-500 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:divide-y-0 lg:w-1/2 lg:flex-none lg:gap-x-8">
                    ...
                    <div className="max-sm:flex max-sm:justify-between max-sm:py-6 max-sm:first:pt-0 max-sm:last:pb-0">
                      ...
                      <dd className="font-medium text-charcoal sm:mt-1">{order.total}</dd>
                    </div>
                  </dl>
                  <a
                    href={order.invoiceHref}
                    className="mt-6 flex w-full items-center justify-center rounded-md border border-gray-300 bg-paper px-4 py-2 text-sm font-medium text-warm-700 shadow-xs hover:bg-paper-soft focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden sm:mt-0 sm:w-auto"
                  >
                    View Invoice
                ...
                <table className="mt-4 w-full text-warm-500 sm:mt-6">
                  <caption className="sr-only">Products</caption>
                  <thead className="sr-only text-left text-sm text-warm-500 sm:not-sr-only">
                    <tr>
                  ...
                  <tbody className="divide-y divide-gray-200 border-b border-paper-200 text-sm sm:border-t">
                    {order.products.map((product) => (
                      <tr key={product.id}>
                        ...
                        <td className="py-6 text-right font-medium whitespace-nowrap">
                          <a href={product.href} className="text-ember">
