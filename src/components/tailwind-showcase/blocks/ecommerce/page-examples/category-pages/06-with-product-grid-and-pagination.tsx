    ...
    <div className="bg-paper">
      ...
      <main className="pb-24">
        <div className="px-4 py-16 text-center sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold tracking-tight text-charcoal">Workspace</h1>
          <p className="mx-auto mt-4 max-w-xl text-base text-warm-500">
        ...
        <Disclosure
          ...
          className="grid items-center border-t border-b border-paper-200"
        >
          ...
          <div className="relative col-start-1 row-start-1 py-4">
            <div className="mx-auto flex max-w-7xl divide-x divide-gray-200 px-4 text-sm sm:px-6 lg:px-8">
              <div className="pr-6">
                <DisclosureButton className="group flex items-center font-medium text-warm-700">
                  <FunnelIcon
                    aria-hidden="true"
                    className="mr-2 size-5 flex-none text-warm-500 group-hover:text-warm-500"
                  />
                  2 Filters
                </DisclosureButton>
              </div>
              <div className="pl-6">
                <button type="button" className="text-warm-500">
                  Clear all
                </button>
              </div>
            </div>
          </div>
          <DisclosurePanel className="border-t border-paper-200 py-10">
                  ...
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
                    {filters.price.map((option, optionIdx) => (
                      <div key={option.value} className="flex gap-3">
                        ...
                        <label htmlFor={`price-${optionIdx}`} className="text-base text-warm-500 sm:text-sm">
                          {option.label}
                        </label>
                      </div>
                    ))}
                  ...
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
                    {filters.color.map((option, optionIdx) => (
                      <div key={option.value} className="flex gap-3">
                        ...
                        <label htmlFor={`color-${optionIdx}`} className="text-base text-warm-500 sm:text-sm">
                          {option.label}
                        </label>
                      </div>
                    ))}
                  ...
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
                    {filters.size.map((option, optionIdx) => (
                      <div key={option.value} className="flex gap-3">
                        ...
                        <label htmlFor={`size-${optionIdx}`} className="text-base text-warm-500 sm:text-sm">
                          {option.label}
                        </label>
                      </div>
                    ))}
                  ...
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
                    {filters.category.map((option, optionIdx) => (
                      <div key={option.value} className="flex gap-3">
                        ...
                        <label htmlFor={`category-${optionIdx}`} className="text-base text-warm-500 sm:text-sm">
                          {option.label}
                        </label>
                      </div>
                    ))}
          ...
          <div className="col-start-1 row-start-1 py-4">
            <div className="mx-auto flex max-w-7xl justify-end px-4 sm:px-6 lg:px-8">
              <Menu as="div" className="relative inline-block">
                ...
                <MenuItems
                  transition
                  className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-paper shadow-2xl ring-1 ring-black/5 transition focus:outline-hidden data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                >
                  <div className="py-1">
        ...
        <section aria-labelledby="products-heading" className="mx-auto max-w-7xl overflow-hidden sm:px-6 lg:px-8">
          ...
          <div className="-mx-px grid grid-cols-2 border-l border-paper-200 sm:mx-0 md:grid-cols-3 lg:grid-cols-4">
            {products.map((product) => (
              <div key={product.id} className="group relative border-r border-b border-paper-200 p-4 sm:p-6">
                <img
                ...
                <div className="pt-10 pb-4 text-center">
                  ...
                  <div className="mt-3 flex flex-col items-center">
                    ...
                    <p className="mt-1 text-sm text-warm-500">{product.reviewCount} reviews</p>
                  </div>
                  <p className="mt-4 text-base font-medium text-charcoal">{product.price}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <nav
          ...
          className="mx-auto mt-6 flex max-w-7xl justify-between px-4 text-sm font-medium text-warm-700 sm:px-6 lg:px-8"
        >
          <div className="min-w-0 flex-1">
            <a
              href="#"
              className="inline-flex h-10 items-center rounded-md border border-gray-300 bg-paper px-4 hover:bg-paper-soft focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/25 focus:ring-offset-1 focus:ring-offset-indigo-600 focus:outline-hidden"
            >
              Previous
            </a>
          </div>
          <div className="hidden space-x-2 sm:flex">
            ...
            <a
              href="#"
              className="inline-flex h-10 items-center rounded-md border border-indigo-600 bg-paper px-4 ring-1 ring-indigo-600 hover:bg-paper-soft focus:ring-2 focus:ring-indigo-600/25 focus:ring-offset-1 focus:ring-offset-indigo-600 focus:outline-hidden"
            >
              3
            </a>
            <span className="inline-flex h-10 items-center px-1.5 text-warm-500">...</span>
            <a
              href="#"
              className="inline-flex h-10 items-center rounded-md border border-gray-300 bg-paper px-4 hover:bg-paper-soft focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/25 focus:ring-offset-1 focus:ring-offset-indigo-600 focus:outline-hidden"
            >
      ...
      <footer aria-labelledby="footer-heading" className="bg-paper">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 border-t border-paper-200 py-20 sm:gap-y-0 lg:grid-cols-4">
