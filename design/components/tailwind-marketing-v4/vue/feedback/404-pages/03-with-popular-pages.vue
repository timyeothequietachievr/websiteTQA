<template>
  <div class="bg-white dark:bg-gray-900">
    <main class="mx-auto w-full max-w-7xl px-6 pt-10 pb-16 sm:pb-24 lg:px-8">
      ...
      <img class="mx-auto h-10 w-auto not-dark:hidden sm:h-12" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" />
