  ...
  return (
    <div className="bg-paper">
      ...
      <main>
        ...
        <section aria-labelledby="trending-heading">
          <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:pt-32">
            <div className="md:flex md:items-center md:justify-between">
              ...
              <a href="#" className="hidden text-sm font-medium text-ember hover:text-indigo-500 md:block">
                Shop the collection
            ...
            <div className="mt-6 grid grid-cols-2 gap-x-4 gap-y-10 sm:gap-x-6 md:grid-cols-4 md:gap-y-0 lg:gap-x-8">
              {trendingProducts.map((product) => (
                <div key={product.id} className="group relative">
                  ...
                  <h3 className="mt-4 text-sm text-warm-700">
                    <a href={product.href}>
                      <span className="absolute inset-0" />
                      {product.name}
                    </a>
        ...
        <section aria-labelledby="perks-heading" className="border-t border-paper-200 bg-paper-soft">
              ...
              {perks.map((perk) => (
                ...
                >
                  ...
                  <div className="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
                    <h3 className="text-base font-medium text-charcoal">{perk.name}</h3>
                    <p className="mt-3 text-sm text-warm-500">{perk.description}</p>
                  </div>
                </div>
              ))}
            </div>
