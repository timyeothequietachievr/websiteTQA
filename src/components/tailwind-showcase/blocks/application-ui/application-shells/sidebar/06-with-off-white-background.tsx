      ...
      */}
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-paper-200 bg-paper px-6">
        ...
        <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-paper px-4 py-4 shadow-xs sm:px-6 lg:hidden">
          ...
          <div className="flex-1 text-sm/6 font-semibold text-charcoal">Dashboard</div>
          <a href="#">
            <span className="sr-only">Your profile</span>
            <img
              alt=""
