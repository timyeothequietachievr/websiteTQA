...
export default function TailwindBlock() {
  return (
    <div className="divide-y divide-charcoal/10/10">
      <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-10 md:grid-cols-3">
        ...
        <form className="bg-paper shadow-xs outline outline-gray-900/5 sm:rounded-xl md:col-span-2">
          ...
          <div className="flex items-center justify-end gap-x-6 border-t border-charcoal/10 px-4 py-4 sm:px-8">
