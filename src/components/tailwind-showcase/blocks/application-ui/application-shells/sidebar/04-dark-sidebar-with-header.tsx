    ...
    <>
      ...
      */}
      <div>
        <Dialog open={sidebarOpen} onClose={setSidebarOpen} className="relative z-50 lg:hidden">
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              ...
              <div className="relative flex grow flex-col gap-y-5 overflow-y-auto bg-ink px-6 pb-4 ring-1 ring-white/10">
                ...
                <nav className="relative flex flex-1 flex-col">
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                      ...
                      <ul role="list" className="-mx-2 mt-2 space-y-1">
                        {teams.map((team) => (
                          <li key={team.name}>
                            ...
                            >
                              <span className="flex size-6 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-paper/5 text-[0.625rem] font-medium text-warm-500 group-hover:border-white/20 group-hover:text-paper">
                                {team.initial}
                              </span>
                    ...
                    <li className="mt-auto">
                      <a
                        href="#"
                        className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-warm-500 hover:bg-paper/5 hover:text-paper"
                      >
        ...
        <div className="hidden bg-ink ring-1 ring-white/10 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
                    ...
                    {teams.map((team) => (
                      <li key={team.name}>
                        <a
                          href={team.href}
                          className={classNames(
                            team.current ? 'bg-paper/5 text-paper' : 'text-warm-500 hover:bg-paper/5 hover:text-paper',
                            'group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold',
                          )}
                        >
                          <span className="flex size-6 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-paper/5 text-[0.625rem] font-medium text-warm-500 group-hover:border-white/20 group-hover:text-paper">
