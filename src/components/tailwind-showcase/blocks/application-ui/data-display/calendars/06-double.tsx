  ...
  return (
    <div>
      <div className="relative grid grid-cols-1 gap-x-14 md:grid-cols-2">
        <button
          type="button"
          className="absolute -top-1 -left-1.5 flex items-center justify-center p-1.5 text-warm-500 hover:text-warm-500"
        >
        ...
        <button
          type="button"
          className="absolute -top-1 -right-1.5 flex items-center justify-center p-1.5 text-warm-500 hover:text-warm-500"
        >
        ...
        {months.map((month, monthIdx) => (
          <section key={monthIdx} className="text-center last:max-md:hidden">
            <h2 className="text-sm font-semibold text-charcoal">{month.name}</h2>
            ...
            <div className="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm shadow-sm ring-1 ring-paper-200">
              {month.days.map((day) => (
                <button
                  ...
                  className="relative bg-paper-soft py-1.5 text-warm-500 first:rounded-tl-lg last:rounded-br-lg hover:bg-paper-soft focus:z-10 data-is-current-month:bg-paper data-is-current-month:text-charcoal data-is-current-month:hover:bg-paper-soft nth-36:rounded-bl-lg nth-7:rounded-tr-lg"
                >
                  <time
                    dateTime={day.date}
                    className="mx-auto flex size-7 items-center justify-center rounded-full in-data-is-today:bg-ember in-data-is-today:font-semibold in-data-is-today:text-paper"
                  >
      ...
      <section className="mt-12">
        <h2 className="text-base font-semibold text-charcoal">Upcoming events</h2>
        <ol className="mt-2 divide-y divide-gray-200 text-sm/6 text-warm-500">
          ...
          <li className="py-4 sm:flex">
            ...
            <p className="mt-2 flex-auto font-semibold text-charcoal sm:mt-0">
