  ...
  return (
    <div className="bg-paper">
      ...
      <main>
        ...
        {/* Trending products */}
        <section aria-labelledby="trending-heading" className="bg-paper">
          <div className="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-32">
            <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
              <h2 id="trending-heading" className="text-2xl font-bold tracking-tight text-charcoal">
                Trending products
              </h2>
                  ...
                  {trendingProducts.map((product) => (
                    <li key={product.id} className="inline-flex w-64 flex-col text-center lg:w-auto">
                      <div className="group relative">
                        ...
                        />
                        <div className="mt-6">
                          <p className="text-sm text-warm-500">{product.color}</p>
                          <h3 className="mt-1 font-semibold text-charcoal">
                            <a href={product.href}>
                              <span className="absolute inset-0" />
                              {product.name}
                            </a>
                          </h3>
                          <p className="mt-1 text-charcoal">{product.price}</p>
                        </div>
                      </div>
            ...
            <div className="mt-12 px-4 sm:hidden">
              <a href="#" className="text-sm font-semibold text-ember hover:text-indigo-500">
                See everything
                <span aria-hidden="true"> &rarr;</span>
              </a>
            </div>
        ...
        {/* Collections */}
        <section aria-labelledby="collections-heading" className="bg-paper-soft">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
              <h2 id="collections-heading" className="text-2xl font-bold text-charcoal">
                Collections
              </h2>
                ...
                {collections.map((collection) => (
                  <div key={collection.name} className="group relative">
                    <img
                      ...
                      className="w-full rounded-lg bg-paper object-cover group-hover:opacity-75 max-sm:h-80 sm:aspect-2/1 lg:aspect-square"
                    />
                    <h3 className="mt-6 text-sm text-warm-500">
                      <a href={collection.href}>
                        <span className="absolute inset-0" />
                        {collection.name}
                      </a>
                    </h3>
                    <p className="text-base font-semibold text-charcoal">{collection.description}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="relative overflow-hidden">
          ...
          >
            <div className="mx-auto max-w-2xl lg:max-w-none">
              <h2 id="sale-heading" className="text-4xl font-bold tracking-tight text-charcoal sm:text-5xl lg:text-6xl">
                Get 25% off during our one-time sale
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-xl text-warm-500">
                Most of our products are limited releases that won't come back. Get your favorite items while they're in
                stock.
              </p>
              <a
                href="#"
                className="mt-6 inline-block w-full rounded-md border border-transparent bg-ink px-8 py-3 font-medium text-paper hover:bg-ink sm:w-auto"
              >
          ...
          >
            <div className="mx-auto max-w-2xl lg:max-w-none">
              <h2 id="testimonial-heading" className="text-2xl font-bold tracking-tight text-charcoal">
                ...
                {testimonials.map((testimonial) => (
                  <blockquote key={testimonial.id} className="sm:flex lg:block">
                    ...
                    <div className="mt-8 sm:mt-0 sm:ml-6 lg:mt-10 lg:ml-0">
                      <p className="text-lg text-warm-500">{testimonial.quote}</p>
                      <cite className="mt-4 block font-semibold text-charcoal not-italic">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="border-t border-paper-200">
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
              <div className="flex items-center rounded-lg bg-paper-soft p-6 sm:p-10">
                <div className="mx-auto max-w-sm">
                  <h3 className="font-semibold text-charcoal">Sign up for our newsletter</h3>
                  ...
                  <form className="mt-4 sm:mt-6 sm:flex">
                    ...
                    <div className="mt-3 sm:mt-0 sm:ml-4 sm:shrink-0">
                      <button
                        type="submit"
                        className="flex w-full items-center justify-center rounded-md border border-transparent bg-ember px-4 py-2 text-base font-medium text-paper shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-white focus:outline-hidden"
                      >
                        Sign up
                      </button>
                    </div>
              ...
              <div className="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
                <div className="absolute inset-0 overflow-hidden rounded-lg">
                  ...
                  />
                  <div className="absolute inset-0 bg-ember/90" />
                </div>
                <div className="relative mx-auto max-w-sm text-center">
                  <h3 className="text-2xl font-bold tracking-tight text-paper">Get early access</h3>
                  <p className="mt-2 text-gray-200">
                    Did you sign up to the newsletter? If so, use the keyword we sent you to get access.{' '}
                    <a href="#" className="font-bold whitespace-nowrap text-paper hover:text-gray-200">
          ...
          <div className="py-10 md:flex md:items-center md:justify-between">
            <div className="text-center md:text-left">
              <p className="text-sm text-warm-500">&copy; 2021 All Rights Reserved</p>
            </div>

            <div className="mt-4 flex items-center justify-center md:mt-0">
              <div className="flex space-x-8">
                {footerNavigation.bottomLinks.map((item) => (
                  <a key={item.name} href={item.href} className="text-sm text-warm-500 hover:text-warm-500">
                    {item.name}
                  </a>
                ))}
              </div>

              <div className="ml-6 border-l border-paper-200 pl-6">
                <a href="#" className="flex items-center text-warm-500 hover:text-warm-500">
                  <img
                    alt=""
                    src="/assets/logo-tqa.jpg"
