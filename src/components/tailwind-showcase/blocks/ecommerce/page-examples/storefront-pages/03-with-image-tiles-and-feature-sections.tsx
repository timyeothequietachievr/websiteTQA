  ...
  return (
    <div className="bg-paper">
      ...
      <header className="relative overflow-hidden">
        {/* Top navigation */}
        <nav aria-label="Top" className="relative z-20 bg-paper/90 backdrop-blur-xl backdrop-filter">
      ...
      <main>
        {/* Category section */}
        <section aria-labelledby="category-heading" className="bg-paper-soft">
              ...
              <div className="group relative aspect-2/1 overflow-hidden rounded-lg sm:row-span-2 sm:aspect-square">
                ...
                <div className="absolute inset-0 flex items-end p-6">
                  <div>
                    ...
                    <p aria-hidden="true" className="mt-1 text-sm text-paper">
                      Shop now
                    </p>
                  </div>
                </div>
        ...
        <section aria-labelledby="cause-heading">
          <div className="relative bg-ink px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
            ...
            <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
              <h2 id="cause-heading" className="text-3xl font-bold tracking-tight text-paper sm:text-4xl">
                Long-term thinking
              </h2>
        ...
        <section aria-labelledby="favorites-heading">
          <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
            <div className="sm:flex sm:items-baseline sm:justify-between">
              <h2 id="favorites-heading" className="text-2xl font-bold tracking-tight text-charcoal">
                Our Favorites
              </h2>
              <a href="#" className="hidden text-sm font-semibold text-ember hover:text-indigo-500 sm:block">
            ...
            <div className="mt-6 grid grid-cols-1 gap-y-10 sm:grid-cols-3 sm:gap-x-6 sm:gap-y-0 lg:gap-x-8">
              {favorites.map((favorite) => (
                <div key={favorite.id} className="group relative">
                  ...
                  <p className="mt-1 text-sm text-warm-500">{favorite.price}</p>
                </div>
              ))}
            </div>
            ...
            <div className="bg-ink">
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="relative pt-48 pb-16 sm:pb-24">
                  <div>
                    <h2 id="sale-heading" className="text-4xl font-bold tracking-tight text-paper md:text-5xl">
                      Final Stock.
                      <br />
                      Up to 50% off.
                    </h2>
                    <div className="mt-6 text-base">
                      <a href="#" className="font-semibold text-paper">
                        Shop the sale
                        <span aria-hidden="true"> &rarr;</span>
                      </a>
                    </div>
      ...
      <footer aria-labelledby="footer-heading" className="bg-paper">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              <div className="space-y-16 md:grid md:grid-cols-2 md:gap-8 md:space-y-0">
                <div>
                  <h3 className="text-sm font-medium text-charcoal">Shop</h3>
          ...
          <div className="border-t border-paper-200 py-10">
