  ...
  <div class="bg-white py-24 md:py-32 dark:bg-gray-900">
    <div class="mx-auto grid max-w-7xl grid-cols-1 gap-20 px-6 lg:px-8 xl:grid-cols-5">
      <div class="max-w-2xl xl:col-span-2">
        <h2 class="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl dark:text-white">About the team</h2>
      ...
      <ul role="list" class="divide-y divide-gray-200 xl:col-span-3 dark:divide-gray-800">
        <li v-for="person in people" :key="person.name" class="flex flex-col gap-10 py-12 first:pt-0 last:pb-0 sm:flex-row">
          <img class="aspect-4/5 w-52 flex-none rounded-2xl object-cover outline-1 -outline-offset-1 outline-black/5 dark:outline-white/10" :src="person.imageUrl" alt="" />
          <div class="max-w-xl flex-auto">
            <h3 class="text-lg/8 font-semibold tracking-tight text-gray-900 dark:text-white">{{ person.name }}</h3>
            <p class="text-base/7 text-gray-600 dark:text-gray-400">{{ person.role }}</p>
            <p class="mt-6 text-base/7 text-gray-600 dark:text-gray-400">{{ person.bio }}</p>
            <ul role="list" class="mt-6 flex gap-x-6">
              <li>
                <a :href="person.xUrl" class="text-gray-400 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
              ...
              <li>
                <a :href="person.linkedinUrl" class="text-gray-400 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
