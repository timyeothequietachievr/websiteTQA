...
export default function TailwindBlock() {
  ...
  return (
    <div className="bg-paper">
      ...
      <main>
        {/* Pricing section */}
        <form className="group/tiers bg-paper pt-24 sm:pt-32">
            ...
            <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 md:max-w-2xl md:grid-cols-2 lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-4">
              {pricing.tiers.map((tier) => (
                <div
                  ...
                  className="group/tier rounded-3xl p-8 ring-1 ring-paper-200 data-featured:ring-2 data-featured:ring-indigo-600"
                >
                  ...
                  <ul role="list" className="mt-8 space-y-3 text-sm/6 text-warm-500">
        ...
        <div className="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:px-8">
          ...
          <div className="mt-16 flex justify-center">
            <p className="relative rounded-full bg-paper-soft px-4 py-1.5 text-sm/6 text-warm-500 inset-ring inset-ring-charcoal/5">
        ...
        <div className="mx-auto mt-24 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden bg-ink px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
            <img
              alt=""
              src="https://images.unsplash.com/photo-1601381718415-a05fb0a261f3?ixid=MXwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8ODl8fHxlbnwwfHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1216&q=80"
              className="absolute inset-0 size-full object-cover brightness-150 saturate-0"
            />
            <div className="absolute inset-0 bg-ink/90 mix-blend-multiply" />
            ...
            <div className="relative mx-auto max-w-2xl lg:mx-0">
              ...
              />
              <figure>
                <blockquote className="mt-6 text-lg font-semibold text-paper sm:text-xl/8">
                  <p>
                    “Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo expedita voluptas culpa sapiente
                    alias molestiae. Numquam corrupti in laborum sed rerum et corporis.”
                  </p>
                </blockquote>
                <figcaption className="mt-6 text-base text-paper">
        ...
        <div className="mx-auto mt-24 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <dl className="mt-16 divide-y divide-charcoal/10/10">
              {faqs.map((faq) => (
                <Disclosure key={faq.question} as="div" className="py-6 first:pt-0 last:pb-0">
                  <dt>
                    <DisclosureButton className="group flex w-full items-start justify-between text-left text-charcoal">
