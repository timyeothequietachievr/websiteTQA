    ...
    <div className="flex h-full flex-col">
      <header className="flex flex-none items-center justify-between border-b border-paper-200 px-6 py-4">
        <div>
          ...
          <p className="mt-1 text-sm text-warm-500">Saturday</p>
        </div>
      ...
      <div className="isolate flex flex-auto overflow-hidden bg-paper">
        <div className="flex flex-auto flex-col overflow-auto">
          <div className="sticky top-0 z-10 grid flex-none grid-cols-7 bg-paper text-xs text-warm-500 shadow-sm ring-1 ring-black/5 md:hidden">
            <button type="button" className="flex flex-col items-center pt-3 pb-1.5">
              <span>W</span>
              {/* Default: "text-charcoal", Selected: "bg-ink text-paper", Today (Not Selected): "text-ember", Today (Selected): "bg-ember text-paper" */}
              <span className="mt-3 flex size-8 items-center justify-center rounded-full text-base font-semibold text-charcoal">
                19
              </span>
            </button>
            <button type="button" className="flex flex-col items-center pt-3 pb-1.5">
              <span>T</span>
              <span className="mt-3 flex size-8 items-center justify-center rounded-full text-base font-semibold text-ember">
                20
              </span>
            </button>
            <button type="button" className="flex flex-col items-center pt-3 pb-1.5">
            ...
            <button type="button" className="flex flex-col items-center pt-3 pb-1.5">
              <span>S</span>
              <span className="mt-3 flex size-8 items-center justify-center rounded-full bg-ink text-base font-semibold text-paper">
                22
              </span>
            </button>
            <button type="button" className="flex flex-col items-center pt-3 pb-1.5">
          ...
          <div className="flex w-full flex-auto">
            <div className="w-14 flex-none bg-paper ring-1 ring-gray-100" />
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                ...
                <div>
                  <div className="-mt-2.5 -ml-14 w-14 pr-2 text-right text-xs/5 text-warm-500">
                    12AM
                  </div>
                </div>
                <div />
              ...
              >
                ...
                >
                  <a
                    href="#"
                    className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-ember-100 p-2 text-xs/5 hover:bg-indigo-100"
                  >
        ...
        <div className="hidden w-1/2 max-w-md flex-none border-l border-gray-100 px-8 py-10 md:block">
          <div className="flex items-center text-center text-charcoal">
            <button
              type="button"
              className="-m-1.5 flex flex-none items-center justify-center p-1.5 text-warm-500 hover:text-warm-500"
            >
          ...
          <div className="mt-6 grid grid-cols-7 text-center text-xs/6 text-warm-500">
            <div>M</div>
            <div>T</div>
            <div>W</div>
            <div>T</div>
          ...
          <div className="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm shadow-sm ring-1 ring-paper-200">
            {days.map((day) => (
              <button
                key={day.date}
                type="button"
                ...
                className="py-1.5 not-data-is-current-month:bg-paper-soft not-data-is-selected:not-data-is-current-month:not-data-is-today:text-warm-500 first:rounded-tl-lg last:rounded-br-lg hover:bg-paper-soft focus:z-10 data-is-current-month:bg-paper not-data-is-selected:data-is-current-month:not-data-is-today:text-charcoal data-is-current-month:hover:bg-paper-soft data-is-selected:font-semibold data-is-selected:text-paper data-is-today:font-semibold data-is-today:not-data-is-selected:text-ember nth-36:rounded-bl-lg nth-7:rounded-tr-lg"
              >
                <time
                  dateTime={day.date}
                  className="mx-auto flex size-7 items-center justify-center rounded-full in-data-is-selected:not-in-data-is-today:bg-ink in-data-is-selected:in-data-is-today:bg-ember"
                >
