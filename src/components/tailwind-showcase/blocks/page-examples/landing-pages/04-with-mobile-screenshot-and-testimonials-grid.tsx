    ...
    <div className="bg-paper">
      ...
      <main>
        ...
        <div className="relative isolate pt-14">
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div className="flex">
                <div className="relative flex items-center gap-x-4 rounded-full bg-paper px-4 py-1 text-sm/6 text-warm-500 ring-1 ring-charcoal/10 hover:ring-charcoal/20">
                  <span className="font-semibold text-ember">We’re hiring</span>
                  <span aria-hidden="true" className="h-4 w-px bg-ink/10" />
                  <a href="#" className="flex items-center gap-x-1">
                    <span aria-hidden="true" className="absolute inset-0" />
                    See open positions
                    <ChevronRightIcon aria-hidden="true" className="-mr-2 size-5 text-warm-500" />
                  </a>
                </div>
              </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-ink px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
              <div className="lg:row-start-2 lg:max-w-md">
                <h2 className="text-3xl font-display font-semibold tracking-tight text-balance text-paper sm:text-4xl">
                ...
                <dl className="max-w-xl space-y-8 text-base/7 text-gray-300 lg:max-w-none">
                  {primaryFeatures.map((feature) => (
                    <div key={feature.name} className="relative">
                      <dt className="ml-9 inline-block font-semibold text-paper">
                        <feature.icon
                          aria-hidden="true"
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-4xl font-display font-semibold tracking-tight text-pretty text-charcoal sm:text-5xl lg:text-balance">
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              {secondaryFeatures.map((feature) => (
                <div key={feature.name} className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-base/7 font-semibold text-charcoal">
                    <feature.icon
                      aria-hidden="true"
                      className="size-5 flex-none text-ember"
                    />
                    {feature.name}
                  </dt>
                  <dd className="mt-4 flex flex-auto flex-col text-base/7 text-warm-500">
                    <p className="flex-auto">{feature.description}</p>
                    <p className="mt-6">
                      <a
                        href={feature.href}
                        className="text-sm/6 font-semibold text-ember hover:text-indigo-500"
                      >
                        Learn more <span aria-hidden="true">→</span>
                      </a>
                    </p>
        ...
        {/* Newsletter section */}
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-ink px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
            <h2 className="mx-auto max-w-3xl text-center text-4xl font-display font-semibold tracking-tight text-paper sm:text-5xl">
          ...
          <div className="relative">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-base/7 font-semibold text-ember">Testimonials</h2>
                <p className="mt-2 text-4xl font-display font-semibold tracking-tight text-balance text-charcoal sm:text-5xl">
                  We have worked with thousands of amazing people
                </p>
              </div>
              <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm/6 text-charcoal sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
                <figure className="rounded-2xl bg-paper shadow-lg ring-1 ring-charcoal/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
                  <blockquote className="p-6 text-lg font-display font-semibold tracking-tight text-charcoal sm:p-12 sm:text-xl/8">
                    <p>{`“${featuredTestimonial.body}”`}</p>
                  </blockquote>
                  <figcaption className="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-charcoal/10 px-6 py-4 sm:flex-nowrap">
                    <img
                      alt=""
                      src={featuredTestimonial.author.imageUrl}
                      className="size-10 flex-none rounded-full bg-paper-soft"
                    />
                    <div className="flex-auto">
                      <div className="font-semibold text-charcoal">
                        {featuredTestimonial.author.name}
                      </div>
                      <div className="text-warm-500">{`@${featuredTestimonial.author.handle}`}</div>
                    </div>
                    <img
                      alt=""
                      ...
                      >
                        {column.map((testimonial) => (
                          <figure
                            ...
                            className="rounded-2xl bg-paper p-6 shadow-lg ring-1 ring-charcoal/5"
                          >
                            ...
                            <figcaption className="mt-6 flex items-center gap-x-4">
                              ...
                              <div>
                                ...
                                <div className="text-warm-500">{`@${testimonial.author.handle}`}</div>
                              </div>
                            </figcaption>
                          </figure>
                        ))}
      ...
      <footer className="mt-32 sm:mt-56">
        <div className="mx-auto max-w-7xl border-t border-paper-200 px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="mt-16 border-t border-charcoal/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
            <div>
              <h3 className="text-sm/6 font-semibold text-charcoal">Subscribe to our newsletter</h3>
            ...
            <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
              ...
              <input
                ...
                placeholder="Enter your email"
                autoComplete="email"
                className="w-full min-w-0 rounded-md bg-paper px-3 py-1.5 text-base text-charcoal outline-1 -outline-offset-1 outline-gray-300 placeholder:text-warm-500 focus:outline-2 focus:-outline-offset-2 focus-visible:outline-ember sm:w-56 sm:text-sm/6"
              />
              <div className="mt-4 sm:mt-0 sm:ml-4 sm:shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-ember px-3 py-2 text-sm font-semibold text-paper shadow-xs hover:bg-ember focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ember"
                >
                  Subscribe
                </button>
              </div>
          ...
          <div className="mt-8 border-t border-charcoal/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-sm/6 text-warm-500 md:order-1 md:mt-0">
