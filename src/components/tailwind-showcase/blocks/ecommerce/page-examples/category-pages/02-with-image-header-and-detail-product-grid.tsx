    ...
    <div className="bg-paper">
      ...
      <div>
        ...
        <Dialog open={mobileFiltersOpen} onClose={setMobileFiltersOpen} className="relative z-40 lg:hidden">
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              ...
              <form className="mt-4">
                {filters.map((section) => (
                  <Disclosure key={section.name} as="div" className="border-t border-paper-200 pt-4 pb-4">
                    <fieldset>
                      <legend className="w-full px-2">
                        <DisclosureButton className="group flex w-full items-center justify-between p-2 text-warm-500 hover:text-warm-500">
                          <span className="text-sm font-medium text-charcoal">{section.name}</span>
                        ...
                        <div className="space-y-6">
                          {section.options.map((option, optionIdx) => (
                            <div key={option.value} className="flex gap-3">
                              ...
                              <label htmlFor={`${section.id}-${optionIdx}-mobile`} className="text-sm text-warm-500">
                                {option.label}
                              </label>
                            </div>
                          ))}
          ...
          <nav aria-label="Breadcrumb" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <ol role="list" className="flex items-center space-x-4 py-4">
              {breadcrumbs.map((breadcrumb) => (
                <li key={breadcrumb.id}>
                  <div className="flex items-center">
                    <a href={breadcrumb.href} className="mr-4 text-sm font-medium text-charcoal">
                      {breadcrumb.name}
                    </a>
              ...
              <li className="text-sm">
                <a href="#" aria-current="page" className="font-medium text-warm-500 hover:text-warm-500">
                  New Arrivals
                </a>
              </li>
            </ol>
        ...
        <main className="mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-8">
          <div className="border-b border-paper-200 pt-24 pb-10">
          ...
          <div className="pt-12 pb-24 lg:grid lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4">
            <aside>
              ...
              >
                ...
                <PlusIcon aria-hidden="true" className="ml-1 size-5 shrink-0 text-warm-500" />
              </button>
                ...
                <form className="divide-y divide-gray-200">
                  {filters.map((section) => (
                    <div key={section.name} className="py-10 first:pt-0 last:pb-0">
                      <fieldset>
                        <legend className="block text-sm font-medium text-charcoal">{section.name}</legend>
                        <div className="space-y-3 pt-6">
                          {section.options.map((option, optionIdx) => (
                            <div key={option.value} className="flex gap-3">
                              ...
                              <label htmlFor={`${section.id}-${optionIdx}`} className="text-sm text-warm-500">
                                {option.label}
                              </label>
                            </div>
                          ))}
            ...
            <section aria-labelledby="product-heading" className="mt-6 lg:col-span-2 lg:mt-0 xl:col-span-3">
              ...
              <div className="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 lg:gap-x-8 xl:grid-cols-3">
                {products.map((product) => (
                  <div
                    key={product.id}
                    className="group relative flex flex-col overflow-hidden rounded-lg border border-paper-200 bg-paper"
                  >
                    <img
                    ...
                    <div className="flex flex-1 flex-col space-y-2 p-4">
                      ...
                      <p className="text-sm text-warm-500">{product.description}</p>
                      <div className="flex flex-1 flex-col justify-end">
                        <p className="text-sm text-warm-500 italic">{product.options}</p>
                        <p className="text-base font-medium text-charcoal">{product.price}</p>
                      </div>
                    </div>
                  </div>
                ))}
