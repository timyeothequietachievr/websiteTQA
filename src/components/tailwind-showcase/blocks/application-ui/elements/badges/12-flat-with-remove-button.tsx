...
export default function TailwindBlock() {
  return (
    <>
      <span className="inline-flex items-center gap-x-0.5 rounded-md bg-paper-soft px-2 py-1 text-xs font-medium text-warm-500">
        Badge
        <button
          type="button"
          className="group relative -mr-1 size-3.5 rounded-xs hover:bg-paper-soft0/20"
        >
      ...
      <span className="inline-flex items-center gap-x-0.5 rounded-md bg-indigo-100 px-2 py-1 text-xs font-medium text-indigo-700">
        ...
        <button
          type="button"
          className="group relative -mr-1 size-3.5 rounded-xs hover:bg-ember/20"
        >
          <span className="sr-only">Remove</span>
          <svg
            viewBox="0 0 14 14"
            className="size-3.5 stroke-indigo-700/50 group-hover:stroke-indigo-700/75"
          >
            <path d="M4 4l6 6m0-6l-6 6" />
          </svg>
          <span className="absolute -inset-1" />
      ...
      <span className="inline-flex items-center gap-x-0.5 rounded-md bg-purple-100 px-2 py-1 text-xs font-medium text-purple-700">
        ...
        >
          ...
          <svg
            viewBox="0 0 14 14"
            className="size-3.5 stroke-violet-700/50 group-hover:stroke-violet-700/75"
          >
            <path d="M4 4l6 6m0-6l-6 6" />
          </svg>
          <span className="absolute -inset-1" />
      ...
      <span className="inline-flex items-center gap-x-0.5 rounded-md bg-pink-100 px-2 py-1 text-xs font-medium text-pink-700">
        ...
        >
          ...
          <svg
            viewBox="0 0 14 14"
            className="size-3.5 stroke-pink-800/50 group-hover:stroke-pink-800/75"
          >
            <path d="M4 4l6 6m0-6l-6 6" />
          </svg>
          <span className="absolute -inset-1" />
