      ...
      {actions.map((action, actionIdx) => (
        <div
          ...
          className={classNames(
            ...
            'group relative border-paper-200 bg-paper p-6 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:odd:not-nth-last-2:border-b sm:even:border-l sm:even:not-last:border-b',
          )}
        >
          <div>
          ...
          <span
            aria-hidden="true"
            className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-warm-500"
          >
