  ...
  return (
    <div className="bg-paper">
      ...
      <main className="isolate">
          ...
          <div className="py-24 sm:py-32 lg:pb-40">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-5xl font-display font-semibold tracking-tight text-balance text-charcoal sm:text-7xl">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 flex justify-center">
            <p className="relative rounded-full bg-paper/25 px-4 py-1.5 text-sm/6 text-warm-500 inset-ring inset-ring-charcoal/10">
              ...
              {features.map((feature) => (
                <div key={feature.name} className="relative pl-16">
                  <dt className="text-base/7 font-semibold text-charcoal">
                    <div className="absolute top-0 left-0 flex size-10 items-center justify-center rounded-lg bg-ember">
                      <feature.icon aria-hidden="true" className="size-6 text-paper" />
                    </div>
                    {feature.name}
                  </dt>
                  <dd className="mt-2 text-base/7 text-warm-500">{feature.description}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <div className="py-24 sm:pt-48">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-center text-lg/8 text-pretty text-warm-500 sm:text-xl/8">
              ...
              {tiers.map((tier, tierIdx) => (
                <div
                  ...
                  className={classNames(
                    ...
                    'flex flex-col justify-between rounded-3xl bg-paper p-8 inset-ring inset-ring-paper-200 xl:p-10',
                  )}
                >
                  <div>
                    <div className="flex items-center justify-between gap-x-4">
                      <h3
                        id={tier.id}
                        className={classNames(
                          tier.mostPopular ? 'text-ember' : 'text-charcoal',
                      ...
                      {tier.mostPopular ? (
                        <p className="rounded-full bg-ember/10 px-2.5 py-1 text-xs/5 font-semibold text-ember">
                          Most popular
                        </p>
                      ) : null}
                    </div>
                  ...
                  <a
                    ...
                    className={classNames(
                      tier.mostPopular
                        ? 'bg-ember text-paper shadow-xs hover:bg-ember'
                        : 'text-ember inset-ring inset-ring-ember-200 hover:inset-ring-indigo-300',
                      'mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ember',
                    )}
                  >
                    Buy plan
                  </a>
      ...
      <footer className="relative mx-auto mt-32 max-w-7xl px-6 lg:px-8">
        <div className="border-t border-charcoal/10 py-16 sm:py-24 lg:py-32">
