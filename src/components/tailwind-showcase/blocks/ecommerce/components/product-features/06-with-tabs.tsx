      ...
      <section aria-labelledby="features-heading" className="mx-auto max-w-7xl py-32 sm:px-2 lg:px-8">
        <div className="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
          <div className="max-w-3xl">
            <h2 id="features-heading" className="text-3xl font-bold tracking-tight text-charcoal sm:text-4xl">
          ...
          <TabGroup className="mt-4">
            <div className="-mx-4 flex overflow-x-auto sm:mx-0">
              <div className="flex-auto border-b border-paper-200 px-4 sm:px-0">
                <TabList className="-mb-px flex space-x-10">
                  {tabs.map((tab) => (
                    <Tab
                      key={tab.name}
                      className="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-warm-500 hover:border-gray-300 hover:text-warm-700 data-selected:border-indigo-500 data-selected:text-ember"
                    >
                      {tab.name}
                    </Tab>
                  ))}
                    ...
                    <div key={feature.name} className="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-x-8">
                      ...
                      <div className="lg:col-span-7">
                        <img
                          ...
                          className="aspect-2/1 w-full rounded-lg bg-paper-soft object-cover sm:aspect-5/2"
                        />
                      </div>
                    </div>
                  ))}
