      ...
      <main className="relative isolate">
        ...
        <div className="px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
            <h1 className="text-5xl font-display font-semibold tracking-tight text-charcoal sm:text-7xl">
              We love creators
            </h1>
        ...
        <div className="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <div className="grid max-w-xl grid-cols-1 gap-8 text-base/7 text-warm-500 lg:max-w-none lg:grid-cols-2">
              <div>
                <p>
            ...
            <dl className="mt-16 grid grid-cols-1 gap-x-8 gap-y-12 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mt-28 lg:grid-cols-4">
              {stats.map((stat, statIdx) => (
                <div
                  key={statIdx}
                  className="flex flex-col-reverse gap-y-3 border-l border-paper-200 pl-6"
                >
                  <dt className="text-base/7 text-warm-500">{stat.label}</dt>
                  <dd className="text-3xl font-display font-semibold tracking-tight text-charcoal">{stat.value}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          ...
          <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base/7 text-warm-500 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-16">
            {values.map((value) => (
          ...
          >
            {team.map((person) => (
              <li key={person.name}>
                ...
                />
                <h3 className="mt-6 text-lg/8 font-display font-semibold tracking-tight text-charcoal">
                  {person.name}
                </h3>
                <p className="text-base/7 text-warm-500">{person.role}</p>
                <p className="text-sm/6 text-warm-500">{person.location}</p>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-40">
          <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-paper/75 px-6 py-16 shadow-lg ring-1 ring-charcoal/5 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
              <img
                alt=""
              ...
              <div className="w-full flex-auto">
                <h2 className="text-4xl font-display font-semibold tracking-tight text-pretty text-gray-950 sm:text-5xl">
                  Join our team
                </h2>
                <p className="mt-6 text-lg/8 text-pretty text-warm-500">
                ...
                <div className="mt-10 flex">
                  <a
                    href="#"
                    className="text-sm/6 font-semibold text-ember hover:text-indigo-300"
                  >
