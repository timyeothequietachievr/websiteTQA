...
export default function TailwindBlock() {
  return (
    <div className="relative isolate bg-paper pt-24 pb-32 sm:pt-32">
      <div
        aria-hidden="true"
          ...
          <figure className="rounded-2xl bg-paper shadow-lg ring-1 ring-charcoal/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
            ...
            <figcaption className="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-charcoal/10 px-6 py-4 sm:flex-nowrap">
              ...
              <div className="flex-auto">
                <div className="font-semibold text-charcoal">{featuredTestimonial.author.name}</div>
                  ...
                  {column.map((testimonial) => (
                    ...
                    >
                      ...
                      <figcaption className="mt-6 flex items-center gap-x-4">
                        ...
                        />
                        <div>
                          <div className="font-semibold text-charcoal">{testimonial.author.name}</div>
