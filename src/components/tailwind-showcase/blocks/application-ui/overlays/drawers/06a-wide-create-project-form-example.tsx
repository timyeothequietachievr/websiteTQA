        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
              ...
              >
                <form className="relative flex h-full flex-col overflow-y-auto bg-paper shadow-xl">
                  <div className="flex-1">
                    {/* Header */}
                    <div className="bg-paper-soft px-4 py-6 sm:px-6">
                    ...
                    <div className="space-y-6 py-6 sm:space-y-0 sm:divide-y sm:divide-gray-200 sm:py-0">
                      ...
                      <div className="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                        <div>
                          <label
                            ...
                            className="block text-sm/6 font-medium text-charcoal sm:mt-1.5"
                          >
                            Project name
                          </label>
                        </div>
                      ...
                      <fieldset className="space-y-2 px-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                        ...
                        <div aria-hidden="true" className="text-sm/6 font-medium text-charcoal">
                          Privacy
                        </div>
                        <div className="space-y-5 sm:col-span-2">
                          <div className="space-y-5 sm:mt-0">
                            <div className="relative flex items-start">
                              ...
                              <div className="pl-7 text-sm/6">
                                <label htmlFor="privacy-public" className="font-medium text-charcoal">
                                  Public access
                                </label>
                            ...
                            <div className="relative flex items-start">
                              ...
                              <div className="pl-7 text-sm/6">
                                <label htmlFor="privacy-private" className="font-medium text-charcoal">
                                  Private to you
                                </label>
                          ...
                          <div className="flex flex-col items-start space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                            <div>
                              <a
                                href="#"
                                className="group flex items-center space-x-2.5 text-sm font-medium text-ember hover:text-indigo-900"
                              >
                                <LinkIcon
                                  aria-hidden="true"
                            ...
                            <div>
                              <a
                                href="#"
                                className="group flex items-center space-x-2.5 text-sm text-warm-500 hover:text-charcoal"
                              >
                  ...
                  {/* Action buttons */}
                  <div className="shrink-0 border-t border-paper-200 px-4 py-5 sm:px-6">
