    ...
    <footer className="bg-ink text-paper">
      <div className="mx-auto max-w-7xl px-6 pt-20 pb-10 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div>
            <span className="font-display text-4xl font-bold tracking-tight text-paper">
              tq<span className="text-sunrise">a</span>
            </span>
            <p className="mt-4 max-w-xs font-display text-sm leading-6 text-paper/70 italic">
              Tiny habits for quiet achievers to have impact at work.
            </p>
          </div>
                ...
                <ul role="list" className="mt-5 space-y-3">
                  {links.map((link) => (
                    <li key={link}>
                      <a
                        href="#"
                        className="text-sm leading-6 text-paper/70 hover:text-paper"
                      >
                        {link}
                      </a>
                    </li>
        ...
        <div className="mt-14 border-t border-paper/15 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs text-paper/50 md:order-1 md:mt-0">
            © 2026 The Quiet Achiever Pte. Ltd. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
