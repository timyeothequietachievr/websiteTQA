          ...
          <tbody className="divide-y divide-gray-200 bg-paper">
            {people.map((person) => (
              <tr key={person.email}>
                ...
                <td className="hidden px-3 py-4 text-sm whitespace-nowrap text-warm-500 sm:table-cell">
                  {person.title}
                </td>
                <td className="hidden px-3 py-4 text-sm whitespace-nowrap text-warm-500 lg:table-cell">
                  {person.email}
                </td>
                <td className="px-3 py-4 text-sm whitespace-nowrap text-warm-500">{person.role}</td>
