...
export const LEGACY_SITE_REDIRECTS: SiteRedirect[] = [
  ...
  { source: "/masterclass", destination: "https://youtu.be/ziv_zoiJRI4", permanent: true },
  { source: "/masterclassreplay", destination: "https://youtu.be/ziv_zoiJRI4", permanent: true },
