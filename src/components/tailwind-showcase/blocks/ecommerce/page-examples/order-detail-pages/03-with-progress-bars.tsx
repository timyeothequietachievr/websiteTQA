    ...
    <div className="bg-paper-soft">
      ...
      <header className="relative">
        <nav aria-label="Top">
          ...
          <div className="border-b border-paper-200 bg-paper">
                    ...
                    <div className="flex h-full space-x-8">
                      {navigation.categories.map((category, categoryIdx) => (
                        <Popover key={category.name} className="flex">
                          ...
                          <PopoverPanel
                            transition
                            className="group absolute inset-x-0 top-full z-20 w-full -translate-y-px bg-paper text-sm text-warm-500 transition data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
                          >
      ...
      <main className="mx-auto max-w-2xl pt-8 pb-24 sm:px-6 sm:pt-16 lg:max-w-7xl lg:px-8">
        <div className="space-y-2 px-4 sm:flex sm:items-baseline sm:justify-between sm:space-y-0 sm:px-0">
          <div className="flex sm:items-baseline sm:space-x-4">
            <h1 className="text-2xl font-bold tracking-tight text-charcoal sm:text-3xl">Order #54879</h1>
            <a href="#" className="hidden text-sm font-medium text-ember hover:text-indigo-500 sm:block">
              View invoice
          ...
          <p className="text-sm text-warm-500">
            Order placed{' '}
            <time dateTime="2021-03-22" className="font-medium text-charcoal">
              March 22, 2021
            </time>
          </p>
          <a href="#" className="text-sm font-medium text-ember hover:text-indigo-500 sm:hidden">
            View invoice
            <span aria-hidden="true"> &rarr;</span>
          </a>
        </div>
          ...
          <div className="space-y-8">
            {products.map((product) => (
              ...
              >
                <div className="px-4 py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
                  <div className="sm:flex lg:col-span-7">
                    ...
                    <div className="mt-6 sm:mt-0 sm:ml-6">
                      ...
                      <p className="mt-2 text-sm font-medium text-charcoal">${product.price}</p>
                      <p className="mt-3 text-sm text-warm-500">{product.description}</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 lg:col-span-5 lg:mt-0">
                    <dl className="grid grid-cols-2 gap-x-6 text-sm">
                      <div>
                        ...
                        <dd className="mt-3 text-warm-500">
                      ...
                      <div>
                        <dt className="font-medium text-charcoal">Shipping updates</dt>
                        <dd className="mt-3 space-y-3 text-warm-500">
                          <p>{product.email}</p>
                          <p>{product.phone}</p>
                          <button type="button" className="font-medium text-ember hover:text-indigo-500">
                            Edit
                          </button>
                        </dd>
                      </div>
                ...
                <div className="border-t border-paper-200 px-4 py-6 sm:px-6 lg:p-8">
                  ...
                  <div aria-hidden="true" className="mt-6">
                    ...
                    <div className="mt-6 hidden grid-cols-4 text-sm font-medium text-warm-500 sm:grid">
                      <div className="text-ember">Order placed</div>
                      <div className={classNames(product.step > 0 ? 'text-ember' : '', 'text-center')}>
                        Processing
                      </div>
                      <div className={classNames(product.step > 1 ? 'text-ember' : '', 'text-center')}>
                        Shipped
                      </div>
                      <div className={classNames(product.step > 2 ? 'text-ember' : '', 'text-right')}>
                        Delivered
                      </div>
                    </div>
                  </div>
        ...
        <section aria-labelledby="summary-heading" className="mt-16">
          ...
          <div className="bg-paper-soft px-4 py-6 sm:rounded-lg sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8 lg:py-8">
            <dl className="grid grid-cols-2 gap-6 text-sm md:gap-x-8 lg:col-span-7">
              ...
              <div>
                <dt className="font-medium text-charcoal">Payment information</dt>
                <dd className="-mt-1 -ml-4 flex flex-wrap">
                  ...
                  <div className="mt-4 ml-4">
                    <p className="text-charcoal">Ending with 4242</p>
                    <p className="text-warm-500">Expires 02 / 24</p>
                  </div>
                </dd>
              </div>
            </dl>
            ...
            <dl className="mt-8 divide-y divide-gray-200 text-sm lg:col-span-5 lg:mt-0">
              <div className="flex items-center justify-between pb-4">
                ...
                <dd className="font-medium text-charcoal">$72</dd>
              </div>
              <div className="flex items-center justify-between py-4">
                <dt className="text-warm-500">Shipping</dt>
                <dd className="font-medium text-charcoal">$5</dd>
              </div>
              <div className="flex items-center justify-between py-4">
                <dt className="text-warm-500">Tax</dt>
                <dd className="font-medium text-charcoal">$6.16</dd>
              </div>
              <div className="flex items-center justify-between pt-4">
                <dt className="font-medium text-charcoal">Order total</dt>
                <dd className="font-medium text-ember">$83.16</dd>
              </div>
            </dl>
          </div>
        </section>
