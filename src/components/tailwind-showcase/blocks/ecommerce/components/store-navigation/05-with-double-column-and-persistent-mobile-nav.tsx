    ...
    <div className="bg-paper">
      <header className="relative bg-paper">
        <nav aria-label="Top" className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="border-b border-paper-200 px-4 pb-14 sm:px-0 sm:pb-0">
                ...
                <div className="flex h-14 space-x-8 overflow-x-auto border-t border-paper-200 px-4 pb-px sm:h-full sm:justify-center sm:overflow-visible sm:border-t-0 sm:pb-0">
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      ...
                      <PopoverPanel
                        transition
                        className="absolute inset-x-0 top-full z-20 w-full bg-paper text-warm-500 transition data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in sm:text-sm"
                      >
