          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between">
              ...
              <div className="-mr-2 flex items-center sm:hidden">
                {/* Mobile menu button */}
                <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md bg-paper p-2 text-warm-500 hover:bg-paper-soft hover:text-warm-500 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600">
