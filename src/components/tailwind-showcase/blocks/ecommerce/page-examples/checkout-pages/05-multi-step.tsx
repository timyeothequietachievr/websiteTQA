    ...
    <div className="bg-paper">
      <header className="flex items-center justify-between px-4 py-10 sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="hidden sm:flex sm:items-center sm:space-x-8">
          <a href="#" className="text-sm font-medium text-warm-700">
            Contact support
          </a>
          ...
          <div className="mx-auto w-full max-w-lg">
                ...
                {products.map((product) => (
                  <li key={product.id} className="flex space-x-6 py-6">
                    <img
                      ...
                      className="size-24 flex-none rounded-md bg-paper-soft object-cover"
                    />
                    <div className="flex-auto">
                      <div className="space-y-1 sm:flex sm:items-start sm:justify-between sm:space-x-6">
                        <div className="flex-auto space-y-1 text-sm font-medium">
                          ...
                          <p className="hidden text-warm-500 sm:block">{product.color}</p>
                          <p className="hidden text-warm-500 sm:block">{product.size}</p>
                        </div>
            ...
            <dl className="mt-10 space-y-6 text-sm font-medium text-warm-500">
              <div className="flex justify-between">
                <dt>Subtotal</dt>
                <dd className="text-charcoal">$104.00</dd>
              </div>
              <div className="flex justify-between">
                <dt>Taxes</dt>
                <dd className="text-charcoal">$8.32</dd>
              </div>
              <div className="flex justify-between">
                <dt>Shipping</dt>
                <dd className="text-charcoal">$14.00</dd>
              </div>
              <div className="flex justify-between border-t border-paper-200 pt-6 text-charcoal">
          ...
          <div className="mx-auto w-full max-w-lg">
            ...
            <form className="mt-6">
              ...
              <div className="mt-6 flex gap-3">
                ...
                <label htmlFor="terms" className="text-sm text-warm-500">
              ...
              <button
                type="submit"
                disabled
                className="mt-6 w-full rounded-md border border-transparent bg-ember px-4 py-2 text-sm font-medium text-paper shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden disabled:cursor-not-allowed disabled:bg-paper-soft disabled:text-warm-500"
              >
                Continue
              </button>
            </form>

            <div className="mt-10 divide-y divide-gray-200 border-t border-b border-paper-200">
              <button
                type="button"
                disabled
                className="w-full cursor-auto py-6 text-left text-lg font-medium text-warm-500"
              >
                Payment details
              </button>
              <button
