    ...
    <>
      ...
      */}
      <main className="lg:flex lg:min-h-full lg:flex-row-reverse lg:overflow-hidden">
        ...
        <section aria-labelledby="order-heading" className="bg-paper-soft px-4 py-6 sm:px-6 lg:hidden">
          <Disclosure as="div" className="mx-auto max-w-lg">
            <div className="flex items-center justify-between">
              <h2 id="order-heading" className="text-lg font-medium text-charcoal">
                Your Order
              </h2>
              <DisclosureButton className="group font-medium text-ember hover:text-indigo-500">
            ...
            <DisclosurePanel>
              <ul role="list" className="divide-y divide-gray-200 border-b border-paper-200">
                  ...
                  <li key={product.id} className="flex space-x-6 py-6">
                    ...
                    <div className="flex flex-col justify-between space-y-4">
                      <div className="space-y-1 text-sm font-medium">
                        <h3 className="text-charcoal">{product.name}</h3>
                        <p className="text-charcoal">{product.price}</p>
                        <p className="text-warm-500">{product.color}</p>
                        <p className="text-warm-500">{product.size}</p>
                      </div>
              ...
              <form className="mt-10">
                <label htmlFor="discount-code-mobile" className="block text-sm/6 font-medium text-warm-700">
                  Discount code
                </label>
                <div className="mt-2 flex space-x-4">
                  ...
                  <button
                    type="submit"
                    className="rounded-md bg-gray-200 px-4 text-sm font-medium text-warm-500 hover:bg-gray-300 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-hidden"
                  >
                    Apply
                  </button>
                </div>
              ...
              <dl className="mt-10 space-y-6 text-sm font-medium text-warm-500">
                <div className="flex justify-between">
                  <dt>Subtotal</dt>
                  <dd className="text-charcoal">{subtotal}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="flex">
                    Discount
                    <span className="ml-2 rounded-full bg-gray-200 px-2 py-0.5 text-xs tracking-wide text-warm-500">
                      {discount.code}
                    </span>
                  </dt>
                  <dd className="text-charcoal">-{discount.amount}</dd>
                </div>
                <div className="flex justify-between">
                  <dt>Taxes</dt>
                  <dd className="text-charcoal">{taxes}</dd>
                </div>
                <div className="flex justify-between">
                  <dt>Shipping</dt>
                  <dd className="text-charcoal">{shipping}</dd>
                </div>
              </dl>
            </DisclosurePanel>

            <p className="mt-6 flex items-center justify-between border-t border-paper-200 pt-6 text-sm font-medium text-charcoal">
        ...
        {/* Order summary */}
        <section aria-labelledby="summary-heading" className="hidden w-full max-w-md flex-col bg-paper-soft lg:flex">
          ...
          <div className="sticky bottom-0 flex-none border-t border-paper-200 bg-paper-soft p-6">
            <form>
              <label htmlFor="discount-code" className="block text-sm/6 font-medium text-warm-700">
                Discount code
              </label>
              <div className="mt-2 flex space-x-4">
                <input
            ...
            <dl className="mt-10 space-y-6 text-sm font-medium text-warm-500">
              ...
              <div className="flex items-center justify-between border-t border-paper-200 pt-6 text-charcoal">
                <dt>Total</dt>
        ...
        >
          ...
          <div className="mx-auto max-w-lg lg:pt-16">
            <button
              type="button"
              className="flex w-full items-center justify-center rounded-md border border-transparent bg-black py-2 text-paper hover:bg-ink focus:ring-2 focus:ring-charcoal focus:ring-offset-2 focus:outline-hidden"
            >
            ...
            <div className="relative mt-8">
              ...
              <div className="relative flex justify-center">
                <span className="bg-paper px-4 text-sm font-medium text-warm-500">or</span>
              </div>
            </div>
            ...
            <form className="mt-6">
              ...
              <button
                type="submit"
                className="mt-6 w-full rounded-md border border-transparent bg-ember px-4 py-2 text-sm font-medium text-paper shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden"
              >
                Pay {total}
              </button>

              <p className="mt-6 flex justify-center text-sm font-medium text-warm-500">
                <LockClosedIcon aria-hidden="true" className="mr-1.5 size-5 text-warm-500" />
