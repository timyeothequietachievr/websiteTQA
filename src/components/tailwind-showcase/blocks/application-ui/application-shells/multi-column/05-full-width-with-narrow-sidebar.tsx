    ...
    <>
      ...
      */}
      <div>
        ...
        <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-ink px-4 py-4 shadow-xs sm:px-6 lg:hidden">
          <button
            type="button"
            onClick={() => setSidebarOpen(true)}
            className="relative -m-2.5 p-2.5 text-warm-500 lg:hidden"
          >
            <span className="sr-only">Open sidebar</span>
            <Bars3Icon aria-hidden="true" className="size-6" />
          </button>
          <div className="relative flex-1 text-sm/6 font-semibold text-paper">Dashboard</div>
        </div>
        ...
        <aside className="fixed inset-y-0 left-20 hidden w-96 overflow-y-auto border-r border-paper-200 px-4 py-6 sm:px-6 lg:px-8 xl:block">
