    ...
    <div className="mx-auto max-w-lg">
      <div>
        ...
        <form action="#" className="mt-6 flex">
          ...
          <button
            type="submit"
            className="ml-4 shrink-0 rounded-md bg-ember px-3 py-2 text-sm font-semibold text-paper shadow-xs hover:bg-ember focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ember"
          >
            Send invite
          </button>
        </form>
      ...
      <div className="mt-10">
        ...
        <ul
          role="list"
          className="mt-4 divide-y divide-gray-200 border-t border-b border-paper-200"
        >
            ...
            <li key={personIdx} className="flex items-center justify-between space-x-3 py-4">
              <div className="flex min-w-0 flex-1 items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-sm font-medium text-warm-500">{person.role}</p>
                </div>
              </div>
              <div className="shrink-0">
                <button
                  type="button"
                  className="inline-flex items-center gap-x-1.5 text-sm/6 font-semibold text-charcoal"
                >
