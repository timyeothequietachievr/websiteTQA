...
function IdentitySkillsGraphic() {
  return (
    <div
      className="flex aspect-[5/2] w-full items-center justify-center rounded-lg bg-ink-deep px-5 py-6 shadow-[0_20px_40px_-24px_rgba(26,26,58,0.45)] ring-1 ring-ink/20 sm:aspect-[4/3] sm:px-8 sm:py-10 lg:px-10 lg:py-12"
      aria-hidden
    >
      <p
        className="font-display text-center font-semibold leading-none tracking-tight text-paper"
        style={{ fontSize: "clamp(28px, 7vw, 72px)", letterSpacing: "-0.03em" }}
      >
        <span>identity</span>
        <span className="mx-2 text-ember sm:mx-5" style={{ fontWeight: 400 }}>
          |
        </span>
        <span>skills</span>
      </p>
