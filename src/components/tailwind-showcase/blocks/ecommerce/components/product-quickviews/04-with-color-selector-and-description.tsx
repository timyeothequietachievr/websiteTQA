                ...
                <div className="sm:col-span-8 lg:col-span-7">
                  ...
                  <section aria-labelledby="information-heading" className="mt-3">
                          ...
                          {[0, 1, 2, 3, 4].map((rating) => (
                            <StarIcon
                              ...
                              className={classNames(
                                product.rating > rating ? 'text-warm-500' : 'text-gray-200',
                                'size-5 shrink-0',
                              )}
                            />
                          ))}
                    ...
                    <div className="mt-6">
                      ...
                      <p className="text-sm text-warm-700">{product.description}</p>
                    </div>
                  </section>
                  ...
                  <section aria-labelledby="options-heading" className="mt-6">
                    ...
                    <form>
                      {/* Colors */}
                      <div>
                        <h4 className="text-sm font-medium text-warm-500">Color</h4>
