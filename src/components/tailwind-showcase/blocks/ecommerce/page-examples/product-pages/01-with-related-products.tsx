    ...
    <div className="bg-paper">
      ...
      <main className="mx-auto mt-8 max-w-2xl px-4 pb-16 sm:px-6 sm:pb-24 lg:max-w-7xl lg:px-8">
        <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
          <div className="lg:col-span-5 lg:col-start-8">
            <div className="flex justify-between">
              <h1 className="text-xl font-medium text-charcoal">{product.name}</h1>
          ...
          <div className="mt-8 lg:col-span-5">
            <form>
              {/* Color picker */}
              <div>
                <h2 className="text-sm font-medium text-charcoal">Color</h2>
              ...
              <div className="mt-8">
                <div className="flex items-center justify-between">
                  <h2 className="text-sm font-medium text-charcoal">Size</h2>
                  <a href="#" className="text-sm font-medium text-ember hover:text-indigo-500">
                    See sizing chart
                  </a>
                </div>
              ...
              <button
                type="submit"
                className="mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-ember px-8 py-3 text-base font-medium text-paper hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden"
              >
                Add to cart
              </button>
            </form>
            ...
            {/* Product details */}
            <div className="mt-10">
              <h2 className="text-sm font-medium text-charcoal">Description</h2>

              <div
                dangerouslySetInnerHTML={{ __html: product.description }}
                className="mt-4 space-y-4 text-sm/6 text-warm-500"
              />
            </div>

            <div className="mt-8 border-t border-paper-200 pt-8">
              <h2 className="text-sm font-medium text-charcoal">Fabric &amp; Care</h2>
            ...
            <section aria-labelledby="policies-heading" className="mt-10">
              ...
              <dl className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                {policies.map((policy) => (
                  <div key={policy.name} className="rounded-lg border border-paper-200 bg-paper-soft p-6 text-center">
                    <dt>
                      <policy.icon aria-hidden="true" className="mx-auto size-6 shrink-0 text-warm-500" />
                      <span className="mt-4 text-sm font-medium text-charcoal">{policy.name}</span>
                    </dt>
                    <dd className="mt-1 text-sm text-warm-500">{policy.description}</dd>
                  </div>
                ))}
              </dl>
            </section>
        ...
        <section aria-labelledby="reviews-heading" className="mt-16 sm:mt-24">
          <h2 id="reviews-heading" className="text-lg font-medium text-charcoal">
            Recent reviews
          </h2>

          <div className="mt-6 divide-y divide-gray-200 border-t border-b border-paper-200">
              ...
              <div key={review.id} className="py-10 lg:grid lg:grid-cols-12 lg:gap-x-8">
                <div className="lg:col-span-8 lg:col-start-5 xl:col-span-9 xl:col-start-4 xl:grid xl:grid-cols-3 xl:items-start xl:gap-x-8">
                  <div className="flex items-center xl:col-span-1">
                    ...
                    <p className="ml-3 text-sm text-warm-700">
                      {review.rating}
                      <span className="sr-only"> out of 5 stars</span>
                    </p>
                  </div>
                ...
                <div className="mt-6 flex items-center text-sm lg:col-span-4 lg:col-start-1 lg:row-start-1 lg:mt-0 lg:flex-col lg:items-start xl:col-span-3">
                  ...
                  <time
                    ...
                    className="ml-4 border-l border-paper-200 pl-4 text-warm-500 lg:mt-2 lg:ml-0 lg:border-0 lg:pl-0"
                  >
                    {review.date}
                  </time>
                </div>
        ...
        <section aria-labelledby="related-heading" className="mt-16 sm:mt-24">
          <h2 id="related-heading" className="text-lg font-medium text-charcoal">
              ...
              <div key={relatedProduct.id} className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-warm-500">{relatedProduct.color}</p>
                  </div>
                  <p className="text-sm font-medium text-charcoal">{relatedProduct.price}</p>
                </div>
              </div>
            ))}
          </div>
