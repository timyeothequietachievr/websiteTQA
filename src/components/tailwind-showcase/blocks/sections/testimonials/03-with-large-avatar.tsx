...
export default function TailwindBlock() {
  return (
    <section className="isolate overflow-hidden bg-paper px-6 lg:px-8">
      <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
        ...
        <div className="absolute inset-y-0 right-1/2 -z-10 mr-12 w-[150vw] origin-bottom-left skew-x-[-30deg] bg-paper shadow-xl ring-1 shadow-indigo-600/10 ring-indigo-50 sm:mr-20 md:mr-0 lg:right-full lg:-mr-36 lg:origin-center" />
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            <svg
              ...
              viewBox="0 0 162 128"
              aria-hidden="true"
              className="absolute -top-12 left-0 -z-10 h-32 stroke-charcoal/10"
            >
              <path
            ...
            <blockquote className="text-xl/8 font-semibold text-charcoal sm:text-2xl/9">
              <p>
          ...
          <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
            <img
              ...
              className="rounded-xl bg-ember-100 lg:rounded-3xl"
            />
          </div>
          <figcaption className="text-base lg:col-start-1 lg:row-start-3">
            <div className="font-semibold text-charcoal">Judith Black</div>
            <div className="mt-1 text-warm-500">CEO of Workcation</div>
          </figcaption>
        </figure>
      </div>
    </section>
