            ...
            <div className="space-y-16 sm:space-y-24">
              {orders.map((order) => (
                <div key={order.number}>
                  ...
                  <div className="bg-paper-soft px-4 py-6 sm:rounded-lg sm:p-6 md:flex md:items-center md:justify-between md:space-x-6 lg:space-x-8">
                    <dl className="flex-auto divide-y divide-gray-200 text-sm text-warm-500 md:grid md:grid-cols-3 md:gap-x-6 md:divide-y-0 lg:w-1/2 lg:flex-none lg:gap-x-8">
                      ...
                      <div className="max-md:flex max-md:justify-between max-md:py-4 max-md:first:pt-0 max-md:last:pb-0">
                        ...
                        <dd className="font-medium text-charcoal md:mt-1">{order.total}</dd>
                      </div>
                    </dl>
                    <div className="mt-6 space-y-4 sm:flex sm:space-y-0 sm:space-x-4 md:mt-0">
                      <a
                        href={order.href}
                        className="flex w-full items-center justify-center rounded-md border border-gray-300 bg-paper px-4 py-2 text-sm font-medium text-warm-700 shadow-xs hover:bg-paper-soft focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden md:w-auto"
                      >
                        View Order
                          ...
                          <div className="min-w-0 flex-1 lg:flex lg:flex-col">
                            <div className="lg:flex-1">
                              <div className="sm:flex">
                                <div>
                                  ...
                                  <p className="mt-2 hidden text-sm text-warm-500 sm:block">{product.description}</p>
                                </div>
                                <p className="mt-1 font-medium text-charcoal sm:mt-0 sm:ml-6">{product.price}</p>
                              </div>
                              <div className="mt-2 flex text-sm font-medium sm:mt-4">
                                <a href={product.href} className="text-ember hover:text-indigo-500">
                                  View Product
                                </a>
                                <div className="ml-4 border-l border-paper-200 pl-4 sm:ml-6 sm:pl-6">
                                  <a href="#" className="text-ember hover:text-indigo-500">
                                    Buy Again
                                  </a>
                                </div>
                              </div>
                            ...
                            <div className="mt-6 font-medium">
                              {product.status === 'delivered' ? (
                                ...
                                <p className="text-warm-500">Cancelled</p>
                              ) : null}
                            </div>
                          </div>
