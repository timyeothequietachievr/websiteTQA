      ...
      <Dialog open={open} onClose={setOpen} className="relative z-10">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-stretch justify-center text-center sm:items-center sm:px-6 lg:px-8">
            ...
            >
              <form className="relative flex w-full flex-col overflow-hidden bg-paper pt-6 pb-8 sm:rounded-lg sm:pb-6 lg:py-8">
                <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8">
                  <h2 className="text-lg font-medium text-charcoal">Shopping Cart</h2>
                  <button type="button" onClick={() => setOpen(false)} className="text-warm-500 hover:text-warm-500">
                    ...
                    {products.map((product, productIdx) => (
                      <li key={product.id} className="flex py-8 text-sm sm:items-center">
                        <img
                          ...
                          className="size-24 flex-none rounded-lg border border-paper-200 sm:size-32"
                        />
                        <div className="ml-4 grid flex-auto grid-cols-1 grid-rows-1 items-start gap-x-5 gap-y-3 sm:ml-6 sm:flex sm:items-center sm:gap-0">
                          <div className="row-end-1 flex-auto sm:pr-6">
                            ...
                            <p className="mt-1 text-warm-500">{product.color}</p>
                          </div>
                          <p className="row-span-2 row-end-2 font-medium text-charcoal sm:order-1 sm:ml-6 sm:w-1/3 sm:flex-none sm:text-right">
                            {product.price}
                          </p>
                          <div className="flex items-center sm:block sm:flex-none sm:text-center">
                            ...
                            <button
                              type="button"
                              className="ml-4 font-medium text-ember hover:text-indigo-500 sm:mt-2 sm:ml-0"
                            >
                              <span>Remove</span>
                            </button>
                          </div>
                ...
                <section aria-labelledby="summary-heading" className="mt-auto sm:px-6 lg:px-8">
                  <div className="bg-paper-soft p-6 sm:rounded-lg sm:p-8">
                    ...
                    <div className="flow-root">
                      <dl className="-my-4 divide-y divide-gray-200 text-sm">
                        <div className="flex items-center justify-between py-4">
                          ...
                          <dd className="font-medium text-charcoal">$262.00</dd>
                        </div>
                        <div className="flex items-center justify-between py-4">
                        ...
                        <div className="flex items-center justify-between py-4">
                          ...
                          <dd className="font-medium text-charcoal">$53.40</dd>
                        </div>
                        <div className="flex items-center justify-between py-4">
                          <dt className="text-base font-medium text-charcoal">Order total</dt>
                          <dd className="text-base font-medium text-charcoal">$320.40</dd>
                        </div>
                      </dl>
                    </div>
                  </div>
