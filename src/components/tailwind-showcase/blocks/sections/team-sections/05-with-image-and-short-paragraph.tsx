...
export default function TailwindBlock() {
  return (
    <div className="bg-paper py-24 md:py-32 lg:py-40">
        ...
        >
          {people.map((person) => (
            <li key={person.name}>
              ...
              />
              <h3 className="mt-6 text-lg/8 font-semibold text-charcoal">{person.name}</h3>
              <p className="text-base/7 text-warm-500">{person.role}</p>
              <p className="mt-4 text-base/7 text-warm-500">{person.bio}</p>
