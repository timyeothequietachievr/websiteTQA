    ...
    <div className="bg-paper">
      ...
      <main>
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm/6 text-warm-500 ring-1 ring-charcoal/10 hover:ring-charcoal/20">
                  ...
                  <a href="#" className="font-semibold text-ember">
        ...
        <div className="mt-32 sm:mt-56">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="text-base/7 font-semibold text-ember">Everything you need</h2>
              <p className="mt-2 text-4xl font-display font-semibold tracking-tight text-pretty text-charcoal sm:text-5xl sm:text-balance">
          ...
          <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
            <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base/7 text-warm-500 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
              {features.map((feature) => (
                <div key={feature.name} className="relative pl-9">
                  <dt className="inline font-semibold text-charcoal">
                    <feature.icon
                      aria-hidden="true"
                      className="absolute top-1 left-1 size-5 text-ember"
                    />
                    {feature.name}
                  </dt>{' '}
        ...
        <div className="relative z-10 mt-32 mb-20 sm:mt-56 sm:mb-24 xl:mb-0">
          ...
          <div className="bg-ink pb-20 sm:pb-24 xl:pb-0">
            <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
              <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                <div className="relative aspect-2/1 h-full after:absolute after:inset-0 after:rounded-2xl after:inset-ring after:inset-ring-white/15 md:-mx-8 xl:mx-0 xl:aspect-auto">
                  <img
                    ...
                    className="absolute inset-0 size-full rounded-2xl bg-ink object-cover shadow-2xl"
                  />
                </div>
              </div>
              <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                <figure className="relative isolate pt-6 sm:pt-12">
                  ...
                  <blockquote className="text-xl/8 font-semibold text-paper sm:text-2xl/9">
                    <p>
                  ...
                  <figcaption className="mt-8 text-base">
                    <div className="font-semibold text-paper">Judith Black</div>
        ...
        <div className="relative isolate mt-32 px-6 sm:mt-56 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg/8 text-pretty text-warm-500">
            ...
            {tiers.map((tier, tierIdx) => (
              <div
                ...
                className={classNames(
                  tier.featured
                    ? 'relative bg-ink shadow-2xl'
                    : 'bg-paper/60 sm:mx-8 lg:mx-0',
                  tier.featured
                    ? ''
                    : tierIdx === 0
                      ? 'rounded-t-3xl sm:rounded-b-none lg:rounded-tr-none lg:rounded-bl-3xl'
                      : 'sm:rounded-t-none lg:rounded-tr-3xl lg:rounded-bl-none',
                  'rounded-3xl p-8 ring-1 ring-charcoal/10 sm:p-10',
                )}
              >
                <h3
                  id={tier.id}
                  className={classNames(
                    tier.featured ? 'text-ember' : 'text-ember',
                ...
                <p className="mt-4 flex items-baseline gap-x-2">
                  <span
                    className={classNames(
                      tier.featured ? 'text-paper' : 'text-charcoal',
                      'text-5xl font-display font-semibold tracking-tight',
                    )}
                  >
                    {tier.priceMonthly}
                  </span>
                  <span
                    className={classNames(
                      tier.featured ? 'text-warm-500' : 'text-warm-500',
                      'text-base',
                    )}
                  >
                    /month
                ...
                <p
                  className={classNames(
                    tier.featured ? 'text-gray-300' : 'text-warm-500',
                    'mt-6 text-base/7',
                  )}
                >
                  {tier.description}
                ...
                <a
                  ...
                  className={classNames(
                    tier.featured
                      ? 'bg-ember text-paper shadow-xs hover:bg-ember-deep focus-visible:outline-ember'
                      : 'text-ember inset-ring inset-ring-ember-200 hover:inset-ring-indigo-300 focus-visible:outline-ember',
      ...
      <footer className="mt-32 sm:mt-56">
        <div className="mx-auto max-w-7xl border-t border-paper-200 px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
