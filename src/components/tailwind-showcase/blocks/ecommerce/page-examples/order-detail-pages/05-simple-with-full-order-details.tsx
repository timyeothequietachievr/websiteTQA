...
export default function TailwindBlock() {
  return (
    <main className="bg-paper px-4 pt-16 pb-24 sm:px-6 sm:pt-24 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-3xl">
        ...
        <section aria-labelledby="order-heading" className="mt-10 border-t border-paper-200">
