      ...
      <div className="space-y-5">
        <div className="flex gap-3">
          ...
          <div className="text-sm/6">
            ...
            <span id="comments-description" className="text-warm-500">
        ...
        <div className="flex gap-3">
          ...
          <div className="text-sm/6">
            ...
            <span id="candidates-description" className="text-warm-500">
        ...
        <div className="flex gap-3">
          ...
          <div className="text-sm/6">
            ...
            <span id="offers-description" className="text-warm-500">
