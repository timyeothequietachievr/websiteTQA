        ...
        <div className="py-24 sm:py-32 lg:pb-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <img
              ...
              width={2432}
              height={1442}
              className="mt-16 rounded-md bg-paper-soft shadow-xl ring-1 ring-charcoal/10 sm:mt-24"
            />
            <img
              alt="App screenshot"
              src="/assets/logo-tqa.jpg"
              width={2432}
              height={1442}
              className="mt-16 rounded-md bg-paper/5 shadow-2xl ring-1 ring-white/10 not-dark:hidden sm:mt-24"
            />
          </div>
        </div>
        <div
