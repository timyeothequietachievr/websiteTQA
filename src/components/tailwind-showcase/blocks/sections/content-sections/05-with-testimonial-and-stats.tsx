      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-4">
            <div className="relative overflow-hidden rounded-3xl bg-ink px-6 pt-64 pb-9 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
              <img
                alt=""
              ...
              />
              <div className="absolute inset-0 bg-ink mix-blend-multiply" />
              <div
                aria-hidden="true"
              ...
              <figure className="relative isolate">
                ...
                />
                <blockquote className="mt-6 text-xl/8 font-semibold text-paper">
                  <p>
                ...
                <figcaption className="mt-6 text-sm/6 text-gray-300">
                  <strong className="font-semibold text-paper">Judith Rogers,</strong> CEO at Workcation
                </figcaption>
              </figure>
            </div>
          </div>
          <div>
            <div className="text-base/7 text-warm-700 lg:max-w-lg">
              <p className="text-base/7 font-semibold text-ember">Company values</p>
            ...
            <dl className="mt-10 grid grid-cols-2 gap-8 border-t border-charcoal/10 pt-10 sm:grid-cols-4">
              {stats.map((stat, statIdx) => (
                <div key={statIdx}>
                  <dt className="text-sm/6 font-semibold text-warm-500">{stat.label}</dt>
                  <dd className="mt-2 text-3xl/10 font-bold tracking-tight text-charcoal">
                    {stat.value}
                  </dd>
                </div>
              ))}
            ...
            <div className="mt-10 flex">
              <a
                href="#"
                className="text-base/7 font-semibold text-ember hover:text-indigo-500"
              >
