  ...
  return (
    <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {people.map((person) => (
        <li
          key={person.email}
          className="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-paper text-center shadow-sm"
        >
          <div className="flex flex-1 flex-col p-8">
            ...
            />
            <h3 className="mt-6 text-sm font-medium text-charcoal">{person.name}</h3>
            <dl className="mt-1 flex grow flex-col justify-between">
              <dt className="sr-only">Title</dt>
              <dd className="text-sm text-warm-500">{person.title}</dd>
            ...
            <div className="-mt-px flex divide-x divide-gray-200">
              <div className="flex w-0 flex-1">
                <a
                  ...
                  className="relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg border border-transparent py-4 text-sm font-semibold text-charcoal"
                >
                  <EnvelopeIcon aria-hidden="true" className="size-5 text-warm-500" />
                  Email
                </a>
              </div>
              <div className="-ml-px flex w-0 flex-1">
                <a
                  ...
                  className="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-charcoal"
                >
                  <PhoneIcon aria-hidden="true" className="size-5 text-warm-500" />
                  Call
                </a>
              </div>
            </div>
