...
export default function TailwindBlock() {
  return (
    <div className="bg-paper">
      ...
      <div aria-hidden="true" className="fixed top-0 right-0 hidden h-full w-1/2 bg-paper-soft lg:block" />
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 xl:gap-x-48">
        ...
        <section
          ...
          className="bg-paper-soft px-4 pt-16 pb-10 sm:px-6 lg:col-start-2 lg:row-start-1 lg:bg-transparent lg:px-0 lg:pb-16"
        >
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <ul role="list" className="divide-y divide-gray-200 text-sm font-medium text-charcoal">
            ...
            <dl className="hidden space-y-6 border-t border-paper-200 pt-6 text-sm font-medium text-charcoal lg:block">
              ...
              <div className="flex items-center justify-between">
                <dt className="text-warm-500">Taxes</dt>
                <dd>$26.80</dd>
              </div>
            ...
            <Popover className="fixed inset-x-0 bottom-0 flex flex-col-reverse text-sm font-medium text-charcoal lg:hidden">
              <div className="relative z-10 border-t border-paper-200 bg-paper px-4 sm:px-6">
                <div className="mx-auto max-w-lg">
                  <PopoverButton className="flex w-full items-center py-6 font-medium">
                    <span className="mr-auto text-base">Total</span>
                    <span className="mr-2 text-base">$361.80</span>
                    <ChevronUpIcon aria-hidden="true" className="size-5 text-warm-500" />
                  </PopoverButton>
                </div>
              </div>
              ...
              <PopoverPanel
                transition
                className="relative transform bg-paper px-4 py-6 transition duration-300 ease-in-out data-closed:translate-y-full sm:px-6"
              >
        ...
        <form className="px-4 pt-16 pb-36 sm:px-6 lg:col-start-1 lg:row-start-1 lg:px-0 lg:pb-16">
          <div className="mx-auto max-w-lg lg:max-w-none">
            <section aria-labelledby="contact-info-heading">
              <h2 id="contact-info-heading" className="text-lg font-medium text-charcoal">
                Contact information
              </h2>
            ...
            <section aria-labelledby="payment-heading" className="mt-10">
              <h2 id="payment-heading" className="text-lg font-medium text-charcoal">
                Payment details
              </h2>
              ...
              <div className="mt-6 grid grid-cols-3 gap-x-4 gap-y-6 sm:grid-cols-4">
                ...
                <div className="col-span-3 sm:col-span-4">
                  <label htmlFor="card-number" className="block text-sm/6 font-medium text-charcoal">
                    Card number
                  </label>
                  <div className="mt-2">
                    <input
            ...
            <section aria-labelledby="shipping-heading" className="mt-10">
              <h2 id="shipping-heading" className="text-lg font-medium text-charcoal">
                Shipping address
              </h2>
            ...
            <section aria-labelledby="billing-heading" className="mt-10">
              <h2 id="billing-heading" className="text-lg font-medium text-charcoal">
                Billing information
              </h2>
              ...
              <div className="mt-6 flex gap-3">
                ...
                <label htmlFor="same-as-shipping" className="text-sm/6 font-medium text-charcoal">
                  Same as shipping information
                </label>
              </div>
            </section>

            <div className="mt-10 border-t border-paper-200 pt-6 sm:flex sm:items-center sm:justify-between">
              <button
                type="submit"
                className="w-full rounded-md border border-transparent bg-ember px-4 py-2 text-sm font-medium text-paper shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-hidden sm:order-last sm:ml-6 sm:w-auto"
              >
                Continue
              </button>
              <p className="mt-4 text-center text-sm text-warm-500 sm:mt-0 sm:text-left">
