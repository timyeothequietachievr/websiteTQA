  ...
  return (
    <>
      {/*
        ...
        ```
      */}
      <div className="grid min-h-full grid-cols-1 grid-rows-[1fr_auto_1fr] bg-paper lg:grid-cols-[max(50%,36rem)_1fr]">
        ...
        <footer className="self-end lg:col-span-2 lg:col-start-1 lg:row-start-3">
          <div className="border-t border-gray-100 bg-paper-soft py-10">
            <nav className="mx-auto flex w-full max-w-7xl items-center gap-x-4 px-6 text-sm/7 text-warm-500 lg:px-8">
