  ...
  return (
    <div className="bg-paper">
      ...
      <main className="isolate">
        {/* Hero section */}
        <div className="relative isolate -z-10 overflow-hidden bg-linear-to-b from-ember-100/20 pt-14">
          <div
            aria-hidden="true"
            className="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-paper shadow-xl ring-1 shadow-indigo-600/10 ring-indigo-50 sm:-mr-80 lg:-mr-96"
          />
          <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              <h1 className="max-w-2xl text-5xl font-display font-semibold tracking-tight text-balance text-charcoal sm:text-7xl lg:col-span-2 xl:col-auto">
                We’re a passionate group of people building the future of ecommerce
              </h1>
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-lg font-medium text-pretty text-warm-500 sm:text-xl/8">
            ...
            {timeline.map((item) => (
              <div key={item.name}>
                <time
                  ...
                  className="flex items-center text-sm/6 font-semibold text-ember"
                >
                  ...
                  <div
                    aria-hidden="true"
                    className="absolute -ml-2 h-px w-screen -translate-x-full bg-ink/10 sm:-ml-4 lg:static lg:-mr-6 lg:ml-8 lg:w-auto lg:flex-auto lg:translate-x-0"
                  />
                </time>
                <p className="mt-6 text-lg/8 font-display font-semibold tracking-tight text-charcoal">{item.name}</p>
                <p className="mt-1 text-base/7 text-warm-500">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-ink px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
            <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-paper sm:text-4xl">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:max-w-none lg:min-w-full lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <p className="mt-6 text-xl/8 text-warm-700">
              ...
              <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
                <div className="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end">
                  <img
                    ...
                    className="aspect-7/5 w-148 max-w-none rounded-2xl bg-paper-soft object-cover max-sm:w-120"
                  />
                </div>
                <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-148 lg:items-start lg:justify-end lg:gap-x-8">
                  <div className="order-first flex w-64 flex-none justify-end self-end max-sm:w-40 lg:w-auto">
                    <img
                      ...
                      className="aspect-4/3 w-[24rem] max-w-none flex-none rounded-2xl bg-paper-soft object-cover"
                    />
                  </div>
                  <div className="flex w-96 flex-auto justify-end lg:w-auto lg:flex-none">
                    <img
                      ...
                      className="aspect-7/5 w-148 max-w-none flex-none rounded-2xl bg-paper-soft object-cover max-sm:w-120"
                    />
                  </div>
                  <div className="hidden sm:block sm:w-0 sm:flex-auto lg:w-auto lg:flex-none">
                    <img
                      ...
                      className="aspect-4/3 w-[24rem] max-w-none rounded-2xl bg-paper-soft object-cover"
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
            <div className="w-full lg:max-w-lg lg:flex-auto">
              <h2 className="text-3xl font-display font-semibold tracking-tight text-pretty text-charcoal sm:text-4xl">
                We’re always looking for awesome people to join us
              </h2>
              <p className="mt-6 text-xl/8 text-warm-500">
                Diam nunc lacus lacus aliquam turpis enim. Eget hac velit est euismod lacus. Est non placerat nam arcu.
                ...
                {jobOpenings.map((opening) => (
                  <li key={opening.id} className="py-8">
                    <dl className="relative flex flex-wrap gap-x-3">
                      ...
                      <dd className="w-full flex-none text-lg font-display font-semibold tracking-tight text-charcoal">
                        <a href={opening.href}>
                          {opening.role}
                      ...
                      <dd className="mt-2 w-full flex-none text-base/7 text-warm-500">
                        {opening.description}
                      </dd>
                      <dt className="sr-only">Salary</dt>
                      <dd className="mt-4 text-base/7 font-semibold text-charcoal">{opening.salary}</dd>
                      <dt className="sr-only">Location</dt>
                      <dd className="mt-4 flex items-center gap-x-3 text-base/7 text-warm-500">
                        <svg
                          viewBox="0 0 2 2"
                          aria-hidden="true"
      ...
      <footer className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div className="border-t border-charcoal/10 pt-20 pb-8 sm:pt-24">
