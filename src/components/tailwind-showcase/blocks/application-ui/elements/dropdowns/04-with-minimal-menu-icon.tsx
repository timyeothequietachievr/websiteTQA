...
export default function TailwindBlock() {
  return (
    <Menu as="div" className="relative inline-block">
      <MenuButton className="flex items-center rounded-full text-warm-500 hover:text-warm-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ember">
        ...
        <div className="py-1">
          ...
          <form action="#" method="POST">
            <MenuItem>
              <button
                type="submit"
                className="block w-full px-4 py-2 text-left text-sm text-warm-700 data-focus:bg-paper-soft data-focus:text-charcoal data-focus:outline-hidden"
              >
                Sign out
              </button>
            </MenuItem>
